	...
	<?php 
		 error_reporting(E_ALL ^ E_NOTICE);     //      To erase the Notice because the variables below first used in this scope
		  ...
		  $lname=$_SESSION['logname'];  // his name to display
		   $Barg=$_SESSION['barg'];
		  $_SESSION['pname']=$pn;
		  if($pn!="Apple MD212HN/A MacBook Pro")
...
<body>
	...
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/Apple.php" title="Acer">Apple</a> / <a href="../LaptopsPage/Apple MD212HN/A MacBook Pro.php" title="Acer Aspire E1-571G-BT Laptop(Black)">Apple MD212HN/A MacBook Pro(Silver)</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/apl51.jpeg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u>Apple MD212HN/A MacBook Pro (Silver)</u></span>
			<br/>
					<br /><br/><br />
					<p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <h2>Specifications of APPLE MD212HN/A MACBOOK PRO (Silver)</h2>
      </div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
