...
<head>
	...
	<?php 
		 error_reporting(E_ALL ^ E_NOTICE);     //      To erase the Notice because the variables below first used in this scope
		  ...
		  $Barg=$_SESSION['barg'];
		  $_SESSION['pname']=$pn;
		  if($pn!="HP Envy Spectre XT 13-2001TU Ultrabook")
...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/HP.php" title="HP">HP</a> / <a href="../LaptopsPage/HP Envy Spectre XT 13-2001TU Ultrabook.php" title="HP">HP Envy&nbsp;Spectre&nbsp;XT 13-2001TU&nbsp;Ultrabook</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/hp11_1.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u>HP Envy&nbsp;Spectre&nbsp;XT 13-2001TU&nbsp;Ultrabook</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/hp11_2.jpg" height="150" width="200" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/hp11_3.jpg" height="150" width="200" onmousemove="showT(src)" />
					 &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/hp11_4.jpg" height="150" width="200" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <strong>
      <h2>Specifications of HP ENVY SPECTRE XT 13-2001TU ULTRABOOK (Brushed&nbsp;Aluminium&nbsp;In&nbsp;Ano&nbsp;Silver Color)</h2>
      <br />
				    <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			        ...
			        <table width="865" cellspacing="5">
		              <tbody>
                        ...
                        <tr>
                          <td>Color</td>
                          <td>Brushed&nbsp;Aluminium&nbsp;In&nbsp;Ano&nbsp;Silver Color</td>
                        </tr>
                        <tr>
                          <td>Part Number</td>
                          <td>B6U56PA</td>
                    ...
                    <table width="865" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td>Clock Speed</td>
                          <td>1.7 GHz with Turbo Boost&nbsp;Upto&nbsp;2.6 GHz</td>
                        </tr>
						<tr>
                          <td>Cache</td>
                          <td>3 MB</td>
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="558">Windows 7 Home Premium </td>
                        </tr>
                        <tr>
                    ...
                    <table width="873" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>Imagepad&nbsp;(Image Sensors Built-in for Accurate Multi-touch Gesture Support))</td>
                        </tr>
                        <tr>
                          <td>Keyboard</td>
                          <td>Backlit Island Keyboard</td>
                        </tr>
                      </tbody>
       </table>
	     ...
	     <br /><br />
                    <table width="875" cellspacing="5">
                      <tbody>
						...
						<tr>
                          <td>Sound</td>
                          <td>Discrete Amplifiers for Headphone and Speaker Out, Envy Branded with Beats Audio</td>
                        </tr> 
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
						...
						<tr>
                          ...
                          <td width="563">10/100/1000 LAN </td>
                        </tr>
                        <tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="562">379.47 x 250.69 x 26.92 mm</td>
                        </tr>
						<tr>
                          <td width="292">Weight</td>
                          <td width="562">1.39 kg </td>
                        </tr>
                      </tbody>
       </table>
