...
<head>
	...
	<?php 
		 error_reporting(E_ALL ^ E_NOTICE);     //      To erase the Notice because the variables below first used in this scope
		  ...
		  $Barg=$_SESSION['barg'];
		  $_SESSION['pname']=$pn;
		  if($pn!="Lenovo ThinkPad T430 (2349O92)")
...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/Lenovo.php" title="Dell">Lenovo</a> / <a href="../LaptopsPage/Lenovo ThinkPad T430 (2349O92).php" title="Dell">Lenovo ThinkPad T430 (2349O92)</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/len12_1.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u> Lenovo ThinkPad T430 (2349O92)</u></span><br/>
		      <br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/len12_2.jpg" height="180" width="200" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/len12_3.jpg" height="200" width="200" onmousemove="showT(src)" />&nbsp;&nbsp;&nbsp;
					  <img src="../css/images/laptop/len12_4.jpg" height="150" width="200" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <strong>
      <h2>Specifications of LENOVO THINKPAD T430 (2349O92)&nbsp;(Black)</h2>
      </strong></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="554">Windows 7 Professional</td>
                        </tr>
                        <tr>
	     ...
	     <br /><br />
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td>Sound</td>
                          <td>Stereo Speakers with Dolby Advanced Audio</td>
                        </tr>                
                   ...
                   <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557">3 Year Onsite Warranty</td>
                        </tr>
					 </tbody>
       </table>
                    <p>&nbsp;</p>
