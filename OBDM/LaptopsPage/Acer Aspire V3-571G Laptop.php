...
<body>
	...
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/Acer.php" title="Acer">Acer / Acer Aspire V3-571G Laptop</a><a href="../LaptopsPage/Acer Aspire V3-571G Laptop.php" title="Acer Aspire E1-571G-BT Laptop(Black)"> (Midnight Black)</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/Avv71.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u>Acer Aspire V3-571G Laptop( Midnight Black)</u></span>
					<br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/Avv72.jpg" height="139" width="100" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/Avv71.jpg" height="139" width="100" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <h2>Specification of ACER ASPIRE V3-571G Laptop(Midnight Black)</h2>
      </div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   ...
                   <br /><br />
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td>Screen Type</td>
                          <td>Active Matrix TFT Color LCD Display with LED Backlit (CineCrystal&nbsp;Technology)</td>
                        </tr>
                      </tbody>
       </table>
                  ...
                  <br /><br />
                    <table width="872" cellspacing="5">
                      ...
                      <td width="296">Graphic Processor</td>
                          <td width="555">NVIDIA GeForce GT 630M</td>
                        </tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="562">Upto 4.5 hours</td>
                        </tr>
                        </tr>
                        <tr>
                          <td>Power Supply</td>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="562">Midnight Black </td>
                        </tr>
						<tr>
