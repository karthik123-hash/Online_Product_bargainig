...
<head>
	...
	<?php 
		 error_reporting(E_ALL ^ E_NOTICE);     //      To erase the Notice because the variables below first used in this scope
		  ...
		  $Barg=$_SESSION['barg'];
		  $_SESSION['pname']=$pn;
		  if($pn!="Lenovo Ideapad S400 (59-340453))")
...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/Lenovo.php" title="Lenovo">Lenovo</a> / <a href="../LaptopsPage/Lenovo Ideapad S400 (59-340453).php" title="Lenovo">Lenovo&nbsp;Ideapad&nbsp;S400 (59-340453)</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/len6_1.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u> Lenovo&nbsp;Ideapad&nbsp;S400 (59-340453)</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/len6_2.jpg" height="180" width="200" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/len6_3.jpg" height="180" width="200" onmousemove="showT(src)" />
					 &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/len6_4.jpg" height="180" width="200" onmousemove="showT(src)" />
					 &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/len6_5.jpg" height="180" width="220" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <strong>
      <h2>Specifications of LENOVO IDEAPAD S400 (59-340453)&nbsp;(Silver Grey)</h2>
      </strong></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  ...
                  <br /><br />
                    <table width="872" cellspacing="5">
                      <tbody>
						...
						<tr>
                          <td width="297">Dedicated Graphics Memory Type</td>
                          <td width="554">DDR3</td>
                        </tr>
						<tr>
                          <td width="297">Dedicated Graphics Memory Capacity</td>
                          <td width="554">1 GB</td>
                        </tr>
                        <tr>
                          <td width="297">Graphic Processor</td>
                          <td width="554">ATI Seymour XT HD7450</td>
                        </tr>
	     ...
	     <br /><br />
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td>Sound</td>
                          <td>Dolby Home Theater v2 Advanced Studio</td>
                        </tr>                
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557">336.6 x 241.2 x 21.9 mm</td>
                        </tr>
						<tr>
                          <td width="297">Weight</td>
                          <td width="557">1.8 kg </td>
                        </tr>
                      </tbody>
       </table>
                   ...
                   <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557">1 Year Inbuilt Onsite +ADP Warranty</td>
                        </tr>
					 </tbody>
       </table>
                    <p>&nbsp;</p>
