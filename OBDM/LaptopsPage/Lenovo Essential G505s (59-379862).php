	...
	<?php 
		 error_reporting(E_ALL ^ E_NOTICE);     //      To erase the Notice because the variables below first used in this scope
		  ...
		  $lname=$_SESSION['logname'];  // his name to display
		   $Barg=$_SESSION['barg'];
		  $_SESSION['pname']=$pn;
		  if($pn!="Lenovo Essential G505s (59-379862)")
...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/Lenovo.php" title="Lenovo">Lenovo</a> / <a href="../LaptopsPage/Lenovo Essential G505s (59-379862).php" title="Lenovo">Lenovo Essential G505s (59-379862)</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/len5_1.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u> Lenovo Essential G505s (59-379862)</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/len5_2.jpg" height="200" width="130" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/len5_1.jpg" height="200" width="200" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <strong>
      <h2>Specifications of LENOVO ESSENTIAL G505S (59-379862)&nbsp;(Midnight Black)</h2>
      </strong></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <table width="865" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="551">APU Quad Core A8</td>
                        </tr>
                        <tr>
                          <td>Variant</td>
                          <td>5550M</td>
                        ...
                        <tr>
                          <td>Clock Speed</td>
                          <td>2.1 GHz with Turbo Core Technology&nbsp;Upto&nbsp;3.1 GHz</td>
                        </tr>
						<tr>
                          <td>Cache</td>
                          <td>4 MB</td>
                    ...
                    <table width="873" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>512 MB AMD Radeon HD 8550G (Integrated) and 2 GB ATI Sunpro HD 8570 Graphics (Dedicated)</td>
                        </tr>
                      </tbody>
       </table>
	     ...
	     <br /><br />
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="298">Sound</td>
                          <td width="556">Stereo Speakers, Dolby Advanced Audio</td>
                        </tr>
						<tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
						...
						<tr>
                          ...
                          <td width="556">10/1000 Ethernet </td>
                        </tr>
                        <tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557">376 x 245 x 34.3 mm</td>
                        </tr>
						<tr>
                   ...
                   <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557">1 Year Onsite Warranty</td>
                        </tr>
					 </tbody>
       </table>
                    <p>&nbsp;</p>
