...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/Dell.php" title="Dell">Dell</a> / <a href="../LaptopsPage/Dell Inspirion 14 3421.php" title="Dell">Dell&nbsp;Inspiron&nbsp;14 3421 Laptop</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/del2_1.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u>Dell Inspirion 14 3421 Laptop</u></span><br/>
					<br /><br/><br />
					<p>
...
</script>			  &nbsp;&nbsp;<img src="../css/images/laptop/del2_2.jpeg" height="139" width="130" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/del2_3.jpeg" height="100" width="200" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <strong>
      <h2>Specifications of DELL INSPIRON 14 3421 Laptop(Black) </h2>
      </strong></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
						...
						<tr>
                          ...
                          <td width="562">346 * 245 * 25.35 mm </td>
                        </tr>
						<tr>
                          <td width="292">Weight</td>
                          <td width="562">1.99 kg </td>
                        </tr>
                      </tbody>
       </table>
                  <br /><br />
