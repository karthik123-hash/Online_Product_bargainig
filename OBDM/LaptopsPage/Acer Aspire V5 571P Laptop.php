	...
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			...
			<br /><br />
					<img id="Main" src="../css/images/laptop/Avv81.jpg" height="280" width="300" align="left"/>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/Avv82.jpg" height="139" width="100" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/Avv81.jpg" height="139" width="100" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <h2>Specifications of ACER ASPIRE V5 571P Laptop</h2>
      </div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   ...
                   <br /><br />
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td>Screen Type</td>
                          <td>HD Active Matrix TFT LCD Display with LED Backlit (CineCrystal&nbsp;Technology)</td>
                        </tr>
                      </tbody>
       </table>
                      ...
                      <tbody>
                        ...
                        <tr>
						 ...
						 <tr>
                          ...
                          <td width="557">Dolby Advanced Audio v2</td>
                        </tr>                 
                      </tbody>
       </table>	
