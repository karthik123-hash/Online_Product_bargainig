...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../MENU/Dell.php" title="Dell">Dell</a> / <a href="../LaptopsPage/Dell Inspiron 5523 Ultrabook.php" title="Dell">Dell&nbsp;Inspiron&nbsp;5523&nbsp;Ultrabook</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/del8_1.jpg" height="250" width="310" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u> Dell Inspiron 5523 Ultrabook</u></span>
					<br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/del8_2.jpg" height="200" width="180" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/del8_1.jpg" height="200" width="230" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <strong>
      <h2>Specifications of DELL INSPIRON 5523 ULTRABOOK (Red)</h2>
      </strong></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557">Slot-load DVD RW Drive</td>
                        </tr>
                      </tbody>
       </table>
	     ...
	     <br /><br />
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="297">Speakers</td>
                          <td width="557">Yes</td>
                        </tr>
                        <tr>
                          <td>Sound</td>
                          <td>Recon3Di High-definition 5.1 Audio with THX TruStudio Pro Software (Standard) 2.1 Speaker Configuration</td>
                        </tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557">Upto 4 hours</td>
                        </tr>
                        </tr>
                        <tr>
                          <td>Power Supply</td>
                          <td>63 W AC Adapter</td>
                        </tr>
                        <tr>
                          <td>Battery Cell</td>
                          <td>8 cell</td>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557">Black</td>
                        </tr>
						<tr>
                          <td width="297">Dimension</td>
                          <td width="557">337 x 258 x 37.8 mm</td>
                        </tr>
						<tr>
                          <td width="297">Weight</td>
                          <td width="557">2.92 kg </td>
                        </tr>
                      </tbody>
       </table>
                  <br /><br />
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="298">Warranty Summary</td>
                          <td width="556">1 Year Warranty</td>
                        </tr>
                      </tbody>
       </table>
                    <p>&nbsp;</p>
