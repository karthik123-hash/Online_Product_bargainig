	...
	<?php 
		 error_reporting(E_ALL ^ E_NOTICE);     //      To erase the Notice because the variables below first used in this scope
		  ...
		  $lname=$_SESSION['logname'];  // his name to display
		   $Barg=$_SESSION['barg'];
		  $_SESSION['pname']=$pn;
		  if($pn!="Sony VAIO Fit 15 F15A15SN/B")
...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/Sony.php" title="Sony">Sony</a> / <a href="../LaptopsPage/Sony VAIO Fit 15 F15A15SNB.php" title="Sony VAIO Fit 15 F15A15SN/B">Sony VAIO Fit 15 F15A15SN/B</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/sn4_1.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u> Sony VAIO Fit&nbsp;15 F15A15SN/B</u></span><br/>
		      <br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/sn4_2.jpg" height="180" width="200" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/sn4_3.jpg" height="200" width="200" onmousemove="showT(src)" />&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <strong>
      <h2>Specifications of SONY VAIO FIT 15 F15A15SN/B&nbsp;(Black)</h2>
      </strong></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="554">SuperMulti&nbsp;DVD RW Drive</td>
                        </tr>
					  </tbody>
       </table>
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
						...
						<tr>
                          ...
                          <td width="554">NVIDIA GeForce GT 735M</td>
                        </tr>
