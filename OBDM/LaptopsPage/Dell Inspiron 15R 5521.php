...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/Dell.php" title="Dell">Dell</a> / <a href="../LaptopsPage/Dell Inspiron 15R 5521.php" title="Dell">Dell&nbsp;Inspiron&nbsp;15R 5521 Laptop</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/del6_1.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u>Dell Inspiron 15R 5521 Laptop</u></span>
					<br />
					<br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/del6_2.jpg" height="139" width="130" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/del6_1.jpg" height="100" width="200" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <div>
        <h2>Specifications of DELL INSPIRON 15R 5521 Laptop (Silver)</h2>
      </div>
      <strong>
      <h3>&nbsp;</h3>
      </strong></div>
	 ...
	 <div class="effect">
                    ...
                    <table width="865" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="295">Processor</td>
                          <td width="549">Core i7 (3rd Generation)</td>
                        </tr>
                        <tr>
                          <td>Variant</td>
                          <td>3537U</td>
                    ...
                    <table width="870" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="296">Expandable Memory</td>
                          <td width="553">Upto 8 GB</td>
                        </tr>
                        <tr>
                          <td>Memory Slots</td>
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="554">Tray-load DVD RW Drive</td>
                        </tr>
                      </tbody>
       </table>
                   ...
                   <br /><br />
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="296">Screen Size</td>
                          <td width="555">15.6 inch</td>
                        </tr>
                        <tr>
                          <td>Screen Type</td>
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="554">AMD Radeon HD 8730M</td>
                        </tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
						...
						<tr>
                          ...
                          <td width="557">2 x USB 2.0, 2 x USB 3.0</td>
                        </tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557">Silver</td>
                        </tr>
						<tr>
                          <td width="297">Dimension</td>
                          <td width="557">376 x 259 x 31.3 mm</td>
                        </tr>
						<tr>
                          <td width="297">Weight</td>
                          <td width="557">2.35 kg </td>
                        </tr>
                      </tbody>
       </table>
	    ...
	    <br /><br />
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="297">Antivirus</td>
                          <td width="557">15 Months McAfee</td>
                        </tr>
                      </tbody>
       </table>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557">1 Year Complete Cover  Warranty</td>
                        </tr>
                      </tbody>
       </table>
                    <p>&nbsp;</p>
