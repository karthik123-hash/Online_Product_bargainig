...
<head>
	...
	<?php 
		 error_reporting(E_ALL ^ E_NOTICE);     //      To erase the Notice because the variables below first used in this scope
		  ...
		  $Barg=$_SESSION['barg'];
		  $_SESSION['pname']=$pn;
		  if($pn!="HP Pavilion 15-e001AX Notebook")
...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/HP.php" title="HP">HP</a> / <a href="../LaptopsPage/HP Pavilion 15-e001AX Notebook.php" title="HP">HP Pavilion 15-e001AX Notebook</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/hp13_1.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u> HP Pavilion 15-e001AX Notebook</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/hp13_2.jpg" height="200" width="130" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/hp13_3.jpg" height="200" width="200" onmousemove="showT(src)" />
					  &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/hp13_4.jpg" height="150" width="200" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <strong>
      <h2>Specifications of HP PAVILION 15-E001AX NOTEBOOK&nbsp;(Metallic Black)</h2>
      </strong></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <table width="865" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="551">APU Quad Core A10</td>
                        </tr>
                        <tr>
                          <td>Variant</td>
                          <td>5750M</td>
                        ...
                        <tr>
                          <td>Clock Speed</td>
                          <td>2.5 GHz with Turbo Core Technology&nbsp;Upto&nbsp;3.5 GHz</td>
                        </tr>
						<tr>
                          <td>Cache</td>
                          <td>4 MB</td>
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
						...
						<tr>
                          ...
                          <td width="557">AMD Radeon HD 8650G and AMD Mobility Radeon HD 8670M</td>
                        </tr>
                  ...
                  <br /><br />
                   <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="306">Warranty Summary</td>
                          <td width="548">1 Year Accidental Damage Protection</td>
                        </tr>
						</tbody>
       </table>
                    <p>&nbsp;</p>
