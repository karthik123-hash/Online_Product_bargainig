...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/HP.php" title="HP">HP</a> / <a href="../LaptopsPage/HP 2000-2313TU.php" title="HP">HP 2000-2313TU&nbsp;</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/hp5_1.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u>HP 2000-2313TU</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/hp5_2.jpg" height="200" width="130" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/hp5_3.jpg" height="150" width="200" onmousemove="showT(src)" />
					  &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/hp5_4.jpg" height="150" width="200" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <strong>
      <h2>Specifications of HP 2000-2313TU Laptop(Glossy Imprint Black Licorice)</h2>
      </strong></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <table width="873" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>Touchpad with Multi Gesture Support (Pinch and Scroll)</td>
                        </tr>
                        <tr>
                          <td>Keyboard</td>
	     ...
	     <br /><br />
                    <table width="875" cellspacing="5">
                      <tbody>
						...
						<tr>
                          <td>Sound</td>
                          <td>Stereo Speakers, HD Audio</td>
                        </tr> 
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="562">375.9 x 246.8 x 35.8 mm</td>
                        </tr>
						<tr>
                   ...
                   <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="563">1 Year Onsite Warranty </td>
                        </tr>
                     </tbody>
       </table>
                    <p>&nbsp;</p>
