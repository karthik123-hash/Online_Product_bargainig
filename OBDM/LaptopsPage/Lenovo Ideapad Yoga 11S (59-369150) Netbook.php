...
<head>
	...
	<?php 
		 error_reporting(E_ALL ^ E_NOTICE);     //      To erase the Notice because the variables below first used in this scope
		  ...
		  $Barg=$_SESSION['barg'];
		  $_SESSION['pname']=$pn;
		  if($pn!="Lenovo Ideapad Yoga 11S (59-369150) Netbook")
...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/Lenovo.php" title="Lenovo">Lenovo</a> / <a href="../LaptopsPage/Lenovo Ideapad Yoga 11S (59-369150) Netbook.php" title="Lenovo">Lenovo&nbsp;Ideapad&nbsp;Yoga 11S (59-369150) Netbook&nbsp;</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/len8_1.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u> Lenovo&nbsp;Ideapad&nbsp;Yoga 11S (59-369150) Netbook&nbsp;</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/len8_2.jpg" height="180" width="200" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/len8_3.jpg" height="180" width="200" onmousemove="showT(src)" />
					 &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/len8_4.jpg" height="180" width="200" onmousemove="showT(src)" /> &nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <strong>
      <h2>Specifications of LENOVO IDEAPAD YOGA 11S (59-369150) NETBOOK&nbsp;(Razor Grey)</h2>
      </strong></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   ...
                   <br /><br />
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td>Screen Type</td>
                          <td>HD 5 Point Multi-touch Display with 360 Degree Foldable Screen</td>
                        </tr>
                      </tbody>
       </table>
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
						...
						<tr>
                          ...
                          <td width="554">NVIDIA ULP GeForce</td>
                        </tr>
                    ...
                    <table width="873" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="555">1.0 Megapixel 720p HD Webcam</td>
                        </tr>
                        <tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557">298 x 204 x 15.6 mm</td>
                        </tr>
						<tr>
                          <td width="297">Weight</td>
                          <td width="557">1.27 kg</td>
                        </tr>
                      </tbody>
       </table>
