	...
	<?php 
		 error_reporting(E_ALL ^ E_NOTICE);     //      To erase the Notice because the variables below first used in this scope
		  ...
		  $lname=$_SESSION['logname'];  // his name to display
		   $Barg=$_SESSION['barg'];
		  $_SESSION['pname']=$pn;
		  if($pn!="Sony VAIO Fit 14E F14212SN/W")
...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/Sony.php" title="Sony">Sony</a> / <a href="../LaptopsPage/Sony VAIO Fit 14E F14212SNW.php" title="Sony VAIO Fit 14E F14212SN/W">Sony VAIO Fit 14E F14212SN/W</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/sn5_1.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u> Sony VAIO Fit 14E F14212SN/W</u></span><br/>
		      <br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/sn5_2.jpg" height="180" width="200" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/sn5_3.jpg" height="200" width="200" onmousemove="showT(src)" />&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <strong>
      <h2>Specifications of SONY VAIO FIT 14E F14212SN/W&nbsp;(White)</h2>
      </strong></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	 ...
	 <div class="effect">
			        ...
			        <table width="865" cellspacing="5">
		              <tbody>
                        ...
                        <tr>
                          <td>Part Number</td>
                          <td>Sony VAIO Fit 14E F14212SN/W Laptop (3rd Gen Ci3/ 2GB/ 500GB/ Win8) (White)</td>
                        </tr>
                        <tr>
                          <td>Model ID</td>
                          <td>F14212SN/W</td>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557">342 x 242.5 x 24.9 mm</td>
                        </tr>
						<tr>
                          <td width="297">Weight</td>
                          <td width="557">2.2 kg</td>
                        </tr>
                      </tbody>
       </table>
