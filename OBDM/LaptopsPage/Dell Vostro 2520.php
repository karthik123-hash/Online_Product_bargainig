...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/Dell.php" title="Dell">Dell</a> / <a href="../LaptopsPage/Dell Vostro 2520.php" title="Dell">Dell&nbsp;Vostro&nbsp;2520 Laptop</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/del10_1.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u> Dell Vostro 2520 Laptop</u></span>
					<br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/del10_3.jpg" height="130" width="250" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/del10_2.jpg" height="200" width="130" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <strong>
      <h2>Specifications of DELL VOSTRO 2520 Laptop (Grey)</h2>
      </strong></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	 ...
	 <div class="effect">
			        ...
			        <table width="865" cellspacing="5">
		              <tbody>
                        ...
                        <tr>
                          <td>Part Number</td>
                          <td>3rd Gen Ci3/ 4GB/ 500GB/ Win8 </td>
                        </tr>
                        <tr>
                          <td>Model ID</td>
                          <td>2520/3rd Gen Ci3/ 4GB/ 500GB/ Win8</td>
                        </tr>
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="296">Operating System</td>
                          <td width="555">Windows 8 </td>
                        </tr>
                        <tr>
	     ...
	     <br /><br />
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
						...
						<tr>
                          <td>Other Ports</td>
                          <td>Headphone Jack, Audio Jack</td>
                        </tr>                    
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
						...
						<tr>
                          ...
                          <td width="557">376 x 260 x 34.5 mm</td>
                        </tr>
						<tr>
                          <td width="297">Weight</td>
                          <td width="557">2.36 kg </td>
                        </tr>
                      </tbody>
       </table>
                  <br /><br />
