...
<body>
	...
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/Acer.php" title="Acer">Acer</a> / <a href="../LaptopsPage/Acer Aspire E1-571G-BT Laptop.php" title="Acer Aspire E1-571G-BT Laptop(Black)">Acer Aspire E1-571G-BT Laptop(Black)</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/A1.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u>Acer Aspire E1-571G-BT Laptop(Black)</u></span>
					<br/><br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/A2.jpg" height="139" width="100" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/A3.jpeg" height="139" width="100" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <span class="style12">Specifications of ACER ASPIRE E1-571G-BT Laptop (Black)</span>
                   ...
                   <br /><br />
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td>Screen Type</td>
                          <td>HD TFT LCD Display with LED Backlit</td>
                        </tr>
                       </tbody>
       </table>
