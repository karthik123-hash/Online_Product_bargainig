	...
	<?php 
		 error_reporting(E_ALL ^ E_NOTICE);     //      To erase the Notice because the variables below first used in this scope
		  ...
		  $lname=$_SESSION['logname'];  // his name to display
		   $Barg=$_SESSION['barg'];
		  $_SESSION['pname']=$pn;
		  if($pn!="Sony VAIO Pro 13 P1321XPN/B Ultrabook")
...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/Sony.php" title="Sony">Sony</a> / <a href="../LaptopsPage/Sony VAIO Pro 13 P1321XPN/B Ultrabook.php" title="Sony VAIO Pro 13 P1321XPN/B Ultrabook">Sony VAIO Pro 13 P1321XPN/B Ultrabook</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/sn9_1.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u> Sony VAIO Pro 13 P1321XPN/B&nbsp;Ultrabook</u></span><br/>
		      <br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/sn9_2.jpg" height="180" width="200" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/sn9_1.jpg" height="200" width="200" onmousemove="showT(src)" />&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <strong>
      <h2>Specifications of SONY VAIO PRO 13 P1321XPN/B ULTRABOOK&nbsp;(Black)</h2>
      </strong></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
						...
						<tr>
                          ...
                          <td width="554">1920 x 1080 Pixel</td>
                        </tr>
                        <tr>
                          <td>Screen Type</td>
                          <td>Full HD TFT Color Display with Capacitive Touch Screen and LED Backlit</td>
                        </tr>
                      </tbody>
       </table>
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
						...
						<tr>
                          ...
                          <td width="554">Intel HD Graphics 4400</td>
                        </tr>
                    ...
                    <table width="873" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="555">0.92 Megapixel HD Webcam</td>
                        </tr>
                        <tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="556">Dual Microphone</td>
                        </tr>
						<tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557">Upto&nbsp;8.5 hours</td>
                        </tr>
                        </tr>
                        <tr>
                          <td>Power Supply</td>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
						...
						<tr>
                          ...
                          <td width="557">2 x USB 3.0 (Including Charging Function</td>
                        </tr>
                         <tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557">322 x 216 x 17.2 mm</td>
                        </tr>
						<tr>
                          <td width="297">Weight</td>
                          <td width="557">1.06 kg</td>
                        </tr>
                      </tbody>
       </table>
	       ...
	       <br /><br />
                   <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="297">Security Chip</td>
                          <td width="557">TCG v1.2 Compliant</td>
                        </tr>
					 </tbody>
       </table>
