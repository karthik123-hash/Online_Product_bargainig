...
<body>
	...
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/Acer.php" title="Acer">Acer / Acer Gateway NE56R Laptop</a><a href="../LaptopsPage/Acer Gateway-NE56R Laptop.php" title="Acer Aspire E1-571G-BT Laptop(Black)">(Black)</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/Avv91.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u>Acer Gateway NE56R Laptop(Black)</u></span>
					<br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/Avv92.jpg" height="139" width="100" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/Avv93.jpg" height="139" width="100" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <h2>Specifications of ACER GATEWAY NE56R Laptop(Black)</h2>
      </div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  ...
                  <br /><br />
                    <table width="872" cellspacing="5">
                      ...
                      <td width="296">Graphic Processor</td>
                          <td width="555">Intel HD Graphics 3000</td>
                        </tr>
                   ...
                   <br /><br />
                    <table width="873" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="293">HD WebCam</td>
                          <td width="559">1.3 Megapixel</td>
                        </tr>
                        <tr>
                          <td>Pointer Device</td>
                          <td>Touchpad with Multi-gesture Support</td>
                        </tr>
                        <tr>
                          <td>Keyboard</td>
				...
				<br /><br />
                    <table width="870" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="292">Speakers</td>
                          <td width="557">Yes</td>
                        </tr>  
						 <tr>
                          <td width="292">Internal Mic</td>
                          <td width="557">Yes</td>
                        </tr>  
						 <tr>
                          <td width="292">Sound</td>
                          <td width="557">HD Audio Support, MS-Sound Compatible, 2 x Stereo Speakers</td>
                        </tr>                 
                      </tbody>
       </table>	
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="562">Black</td>
                        </tr>
						<tr>
                          <td width="292">Dimension</td>
                          <td width="562">381.6 x 253 x 33.2 mm</td>
                        </tr>
						<tr>
                          <td width="292">Weight</td>
                          <td width="562">2.6kg</td>
                        </tr>
                      </tbody>
       </table>
                  <br /><br />
