	...
	<?php 
		 error_reporting(E_ALL ^ E_NOTICE);     //      To erase the Notice because the variables below first used in this scope
		  ...
		  $lname=$_SESSION['logname'];  // his name to display
		   $Barg=$_SESSION['barg'];
		  $_SESSION['pname']=$pn;
		  if($pn!="Apple MD761HN/A MacBook Air")
...
<body>
	...
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/Apple.php" title="Acer">Apple</a> / <a href="../LaptopsPage/Apple MD761HN.php" title="Acer Aspire E1-571G-BT Laptop(Black)">Apple MD761HN / A MacBook Air (Silver)</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/MD760HN_1.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u>Apple MD761HN/A MacBook Air (Silver)</u></span>
			<br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/MD760HN_2.jpg" height="150" width="150" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
			  &nbsp;&nbsp;<img src="../css/images/laptop/MD760HN_3.jpg" height="150" width="150" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
			  &nbsp;&nbsp;<img src="../css/images/laptop/MD760HN_4.jpg" height="20" width="150"/> &nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <h2>Specifications of APPLE MD761HN/A MACBOOK AIR (Silver)</h2>
      </div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <table width="865" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="551">Core i5 (4th Generation) </td>
                        </tr>
                        <tr>
                          <td>Brand</td>
                          <td>Intel</td>
				  ...
				  <br /><br />
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td>Screen Type</td>
                          <td>LED Backlit Glossy Display</td>
                        </tr>
						<tr>
                          <td>Resolution</td>
                          <td>1440 * 900   pixel</td>
                        </tr>
                      </tbody>
       </table>
                  ...
                  <br /><br />
                    <table width="872" cellspacing="5">
                      ...
                      <td width="296">Graphic Processor</td>
                          <td width="555">Intel HD Graphics 5000</td>
                        </tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="562">Upto 12 hours</td>
                        </tr>
                        </tr>
                        <tr>
                          <td>Power Supply</td>
                          <td>45W MagSafe 2 Power Adapter</td>
                        </tr>
