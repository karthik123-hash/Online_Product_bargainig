...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/Dell.php" title="Dell">Dell</a> / <a href="../LaptopsPage/Dell XPS 13.php" title="Dell">Dell XPS 13 Laptop</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/del12_1.jpg" height="260" width="350" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u>Dell XPS 13 Laptop</u></span>
					<br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/del12_2.jpg" height="200" width="130" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/del12_1.jpg" height="200" width="200" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <strong>
      <h2>Specifications of DELL XPS 13 Laptop (Aluminium Silver)</h2>
      </strong></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	 ...
	 <div class="effect">
                    ...
                    <table width="865" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="547">Core i7 (2rd Generation)</td>
                        </tr>
                        <tr>
                          <td>Variant</td>
                          <td>2637M</td>
                        ...
                        <tr>
                          <td>Clock Speed</td>
                          <td>1.7 GHz with Turbo Boost&nbsp;Upto&nbsp;2.8 GHz</td>
                        </tr>
						<tr>
                          <td>Cache</td>
                          <td>4 MB</td>
                    ...
                    <table width="871" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="298">HDD Capacity</td>
                          <td width="552">256 GB SSD</td>
                        </tr>
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="555">Windows 7 Home Premium</td>
                        </tr>
                        <tr>
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="554">Intel HD Graphics 3000</td>
                        </tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
						...
						<tr>
                          ...
                          <td width="556">Intel Centrino Advanced-N 6230</td>
                        </tr>
                        <tr>
                          <td>Bluetooth</td>
                          <td>v4.0</td>
	     ...
	     <br /><br />
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
						...
						<tr>
                          <td width="296">RJ45 LAN</td>
                          <td width="558">Yes</td>
                        </tr>
						<tr>
                          <td width="296">VGA Port</td>
                          <td width="558">Yes</td>
                        </tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557">Aluminium Silver</td>
                        </tr>
						</tbody>
       </table>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557">3 Years XPS Premier Service with Complete Cover Accidental Damage Protection Warranty</td>
                        </tr>
                      </tbody>
       </table>
                    <p>&nbsp;</p>
