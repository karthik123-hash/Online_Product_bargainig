...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/Dell.php" title="Dell">Dell</a> / <a href="../LaptopsPage/Dell Inspiron 15-3521.php" title="Dell">Dell&nbsp;Inspiron&nbsp;15 3521 Laptop</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/del5_1.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u>Dell Inspiron 15 3521 Laptop</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/del4_2.jpg" height="139" width="130" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/del4_1.jpg" height="100" width="200" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <strong>      </strong>
      <div>
        <h2><strong>Specifications of DELL INSPIRON 15 3521 Laptop (Black)</strong></h2>
      </div>
      <strong>
      <h3>&nbsp;</h3>
      </strong></div>
                  ...
                  <br /><br />
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="293">Graphic Processor</td>
                          <td width="558">AMD Radeon HD 8730M</td>
                        </tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
						...
						<tr>
                          ...
                          <td width="559">2 x USB 2.0, 2 x USB 3.0</td>
                        </tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
						...
						<tr>
                          ...
                          <td width="562">376 x 259 x 31.3 mm</td>
                        </tr>
						<tr>
                          <td width="292">Weight</td>
                          <td width="562">2.35 kg </td>
                        </tr>
                      </tbody>
       </table>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="563">1 Year Complete Cover Onsite Warranty</td>
                        </tr>
                      </tbody>
       </table>
                    <p>&nbsp;</p>
