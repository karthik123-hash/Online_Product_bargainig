	...
	<?php 
		 error_reporting(E_ALL ^ E_NOTICE);     //      To erase the Notice because the variables below first used in this scope
		  ...
		  $lname=$_SESSION['logname'];  // his name to display
		   $Barg=$_SESSION['barg'];
		  $_SESSION['pname']=$pn;
		  if($pn!="Apple MD711HN/A MacBook Air")
...
<body>
	...
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/Apple.php" title="Acer">Apple</a> / <a href="../LaptopsPage/Apple MD711HNA MacBook Air.php" title="Acer Aspire E1-571G-BT Laptop(Black)">Apple MD711HN /A MacBook Air (Silver)</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/md711_1.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u>Apple MD711HN/A MacBook Air (Silver)</u></span>
			<br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/md711_2.jpg" height="150" width="180" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
			  &nbsp;&nbsp;<img src="../css/images/laptop/md711_3.jpg" height="150" width="180" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <h3>Specifications of APPLE MD711HN/A MACBOOK AIR (Silver)</h3>
      </div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
