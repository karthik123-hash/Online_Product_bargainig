...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/Dell.php" title="Dell">Dell</a> / <a href="../LaptopsPage/Dell Alienware M14X R2.php" title="Dell">Dell Alienware M14X R2 Laptop</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/del1_1.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u>Dell Alienware M14X R2 Laptop</u></span>
					<br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/del1_2.jpg" height="139" width="130" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/del1_3.jpg" height="50" width="200" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <strong><h2>Specifications of DELL ALIENWARE M14X R2 Laptop(Black)</h2>
			      </strong></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	 ...
	 <div class="effect">
                    ...
                    <table width="865" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td>Clock Speed</td>
                          <td>2.2 GHz with Turbo Boost&nbsp;Upto&nbsp;3.4 GHz</td>
                        </tr>
						<tr>
                          <td>Cache</td>
                          <td>6 MB</td>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
						...
						<tr>
                          ...
                          <td width="562">337 x 258 x 37.8 mm</td>
                        </tr>
						<tr>
                          <td width="292">Weight</td>
                          <td width="562">2.92 kg </td>
                        </tr>
                      </tbody>
       </table>
                  <br /><br />
