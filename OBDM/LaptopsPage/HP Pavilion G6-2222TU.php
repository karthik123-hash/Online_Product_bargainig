...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/HP.php" title="HP">HP</a> / <a href="../LaptopsPage/HP Pavilion G6-2222TU.php" title="HP">HP Pavilion G6-2222TU</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/hp18_1.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u> HP Pavilion G6-2222TU</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/hp18_2.jpg" height="200" width="130" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/hp18_3.jpg" height="200" width="200" onmousemove="showT(src)" />
					  &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/hp18_4.jpg" height="150" width="200" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <strong>
      <h2>Specifications of HP PAVILION G6-2222TU&nbsp;(Imprint Sparkling Black)</h2>
      </strong></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
