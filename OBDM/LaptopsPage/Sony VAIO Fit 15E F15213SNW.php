	...
	<?php 
		 error_reporting(E_ALL ^ E_NOTICE);     //      To erase the Notice because the variables below first used in this scope
		  ...
		  $lname=$_SESSION['logname'];  // his name to display
		   $Barg=$_SESSION['barg'];
		  $_SESSION['pname']=$pn;
		  if($pn!="Sony VAIO Fit 15E F15213SN/W")
...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/Sony.php" title="Sony">Sony</a> / <a href="../LaptopsPage/Sony VAIO Fit 15E F15213SNW.php" title="Sony VAIO Fit 15E F15213SN/W">Sony VAIO Fit 15E F15213SN/W</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/sn6_1.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u> Sony VAIO Fit 15E F15213SN/W</u></span><br/>
		      <br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/sn6_2.jpg" height="180" width="200" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/sn6_3.jpg" height="150" width="200" onmousemove="showT(src)" />&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <strong>      </strong>
      <h2>Specifications of SONY VAIO FIT 15E F15213SN/W (White)</h2>
      <strong>
	 ...
	 <div class="effect">
			        ...
			        <table width="865" cellspacing="5">
		              <tbody>
                        ...
                        <tr>
                          <td>Part Number</td>
                          <td>Sony VAIO Fit 15E F15213SN/W Laptop (3rd Gen Ci3/ 4GB/ 500GB/ Win8/ 1GB Graph) (White)</td>
                        </tr>
                        <tr>
                          <td>Model ID</td>
                          <td>F15213SN/W</td>
                   ...
                   <br /><br />
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td>Screen Type</td>
                          <td>TFT&nbsp;Colour&nbsp;Display (VAIO Display, LED Backlight)</td>
                        </tr>
                      </tbody>
       </table>
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
						...
						<tr>
                          ...
                          <td width="554">NVIDIA GeForce GT 740M</td>
                        </tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
						...
						<tr>
                          ...
                          <td width="556">10/100/1000 BASE-T </td>
                        </tr>
                        <tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
						...
						<tr>
                          ...
                          <td width="557">2 x USB 2.0, 2 x USB 3.0 (Including Charging Function</td>
                        </tr>
                         <tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557">380.3 x 260.8 x 25.1 mm</td>
                        </tr>
						<tr>
                          <td width="297">Weight</td>
                          <td width="557">2.5 kg</td>
                        </tr>
                      </tbody>
       </table>
