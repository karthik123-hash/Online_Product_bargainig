...
<body>
	...
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/Acer.php" title="Acer">Acer / Acer Aspire V5-571 Laptop</a><a href="../LaptopsPage/Acer Aspire V5-571 Laptop.php" title="Acer Aspire E1-571G-BT Laptop(Black)"> (Silver)</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/Av51.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u>Acer Aspire V5-571 Laptop( Silver)</u></span>
					<br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/Av52.jpg" height="139" width="100" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/Av53.jpg" height="139" width="100" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <h2>Specifications of ACER ASPIRE V5-571 Laptop(Silver)</h2>
      </div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   ...
                   <br /><br />
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td>Screen Type</td>
                          <td>Active Matrix HD TFT LCD Display with LED Backlit (CineCrystal&nbsp;Technology)</td>
                        </tr>
                      </tbody>
       </table>
