...
<head>
	...
	<?php 
		 error_reporting(E_ALL ^ E_NOTICE);     //      To erase the Notice because the variables below first used in this scope
		  ...
		  $_SESSION['pname']=$pn;
		  if($pn!="Lenovo Essential G500s (59-388254)")
...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/Lenovo.php" title="Lenovo">Lenovo</a> / <a href="../LaptopsPage/Lenovo Essential G500s (59-388254).php" title="Lenovo">Lenovo Essential G500s (59-388254)</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/len2_1.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u> Lenovo Essential G500s (59-388254)</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/len2_2.jpg" height="200" width="130" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/len2_3.jpg" height="200" width="200" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <strong>
      <h2>Specifications of LENOVO ESSENTIAL G500S (59-388254)&nbsp;(Black)</h2>
      </strong></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <tbody>
                        ...
                        <tr>
						 ...
						 <tr>
                          ...
                          <td width="554">NVIDIA GeForce GT 720M</td>
                        </tr>
	     ...
	     <br /><br />
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td>Sound</td>
                          <td>Stereo Speakers, Dolby Advanced Audio</td>
                        </tr>                
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557">380 x 260 x 25.8 mm</td>
                        </tr>
						<tr>
                   ...
                   <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557">1 Year Onsite Parts and Labor Warranty</td>
                        </tr>
					 </tbody>
       </table>
                    <p>&nbsp;</p>
