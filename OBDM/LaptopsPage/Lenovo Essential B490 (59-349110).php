...
<head>
	...
	<?php 
		 error_reporting(E_ALL ^ E_NOTICE);     //      To erase the Notice because the variables below first used in this scope
		  ...
		  $Barg=$_SESSION['barg'];
		  $_SESSION['pname']=$pn;
		  if($pn!="Lenovo Essential B490 (59-349110)")
...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/Lenovo.php" title="Lenovo">Lenovo</a> / <a href="../LaptopsPage/Lenovo Essential B490(59-349110).php" title="Lenovo">Lenovo Essential B490 (59-349110)</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/len1_1.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u> Lenovo Essential B490(59-349110)</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/len1_2.jpg" height="200" width="130" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/len1_1.jpg" height="200" width="200" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <strong>
      <h2>Specifications of LENOVO ESSENTIAL B490(59-349110)&nbsp;(Black)</h2>
      </strong></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <table width="873" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>TouchPad&nbsp;with Multi-Touch Support</td>
                        </tr>
                        <tr>
                          <td>Keyboard</td>
	     ...
	     <br /><br />
                   ...
                   <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="297">Fingerprint Sensor</td>
                          <td width="557">Yes</td>
                        </tr>
						<tr>
