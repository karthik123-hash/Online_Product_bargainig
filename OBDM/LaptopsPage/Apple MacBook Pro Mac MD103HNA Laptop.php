...
<head>
	...
	<?php 
		 error_reporting(E_ALL ^ E_NOTICE);     //      To erase the Notice because the variables below first used in this scope
		  ...
		  $Barg=$_SESSION['barg'];
		  $_SESSION['pname']=$pn;
		  if($pn!="Apple MacBook Pro Mac MD103HN/A")
...
<body>
	...
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/Apple.php" title="Acer">Apple</a> / <a href="../LaptopsPage/Apple MacBook Pro Mac MD103HN/A Laptop.php" title="Acer Aspire E1-571G-BT Laptop(Black)">Apple MacBook Pro Mac MD103HN/A Laptop(Silver)</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/apl8_1.jpeg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u>Apple MacBook Pro Mac MD103HN/A Laptop (Silver)</u></span>
					<br/>
					<br /><br/><br />
					<p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <h2>Specifications of APPLE MACBOOK PRO MAC MD103HN/A Laptop(Silver)</h2>
      </div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	 				...
	 				<table width="865" cellspacing="5">
					  <tbody>
                        ...
                        <tr>
                          ...
                          <td width="549">AC Wall&nbsp;Plug,Magsafe&nbsp;2 Power&nbsp;Adapter,Power&nbsp;Lead</td>
                        </tr>
					  </tbody>
	   </table>
                    ...
                    <table width="865" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="551">Intel Core i7 (2nd Generation)</td>
                        </tr>
                        <tr>
                          <td>Brand</td>
                          <td>Intel</td>
				  ...
				  <br /><br />
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td>Screen Type</td>
                          <td>LED-backlit Display with IPS Technology </td>
                        </tr>
						<tr>
                          <td>Resolution</td>
                          <td>1400 * 900  pixel</td>
                        </tr>
                      </tbody>
       </table>
                  ...
                  <br /><br />
                    <table width="872" cellspacing="5">
                      ...
                      <td width="296">Graphic Processor</td>
                          <td width="555">NVIDIA GeForce GT 650M</td>
                        </tr>
