...
<body>
	...
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/Acer.php" title="Acer">Acer / Acer Aspire V5-571P Laptop</a><a href="../LaptopsPage/Acer Aspire V5-571P Laptop.php" title="Acer Aspire E1-571G-BT Laptop(Black)"> (Silver)</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/Avv1.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u>Acer Aspire V5-571P Laptop(Silver)</u></span>
					<br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/Avv2.jpg" height="139" width="100" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/Avv3.jpg" height="139" width="100" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <h2>Specifications of ACER ASPIRE V5-571P Laptop(Silver)</h2>
      </div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   ...
                   <br /><br />
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td>Screen Type</td>
                          <td>HD Active Matrix TFT Color LCD Display with LED Backlit (CineCrystal&nbsp;Technology</td>
                        </tr>
                      </tbody>
       </table>
	     ...
	     <br /><br />
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td>HDMI Port</td>
                          <td>Yes, HDMI Port with HDCP Suppor</td>
                        </tr>
						<tr>
