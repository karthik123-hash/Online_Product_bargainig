...
<body>
	...
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/Acer.php" title="Acer">Acer / Acer Aspire V5-471P Laptop</a><a href="../LaptopsPage/Acer Aspire V5-471P Laptop.php" title="Acer Aspire E1-571G-BT Laptop(Black)"> (Misty Silver)</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/Avv41.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u>Acer Aspire V5-471P Laptop(Misty Silver)</u></span>
					<br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/Avv42.jpg" height="139" width="100" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/Avv41.jpg" height="139" width="100" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <h2>Specifications of ACER ASPIRE V5-471P Laptop(Misty Silver)</h2>
      </div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <table width="865" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="551">Core i3 (2rd Generation)</td>
                        </tr>
                        <tr>
                          <td>Variant</td>
                          <td>23657U</td>
                   ...
                   <br /><br />
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td>Screen Type</td>
                          <td>HD TFT LCD Display with LED Backlit (CineCrystal&nbsp;Technology) and Integrated Multi-touch Supporting 10 Finger Touch</td>
                        </tr>
                      </tbody>
       </table>
                    ...
                    <table width="873" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>Multi-gesture Touchpad (Supporting Two-finger Scroll, Pinch, Swipe, Flip)</td>
                        </tr>
                        <tr>
                          <td>Keyboard</td>
                          <td>Acer Fine Tip Keyboard</td>
                        </tr>
                      </tbody>
       </table>
				<br /><br />
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="562">Misty Silver</td>
                        </tr>
						<tr>
                          <td width="292">Dimension</td>
                          <td width="562">382 x 253 x 23 mm</td>
                        </tr>
						<tr>
