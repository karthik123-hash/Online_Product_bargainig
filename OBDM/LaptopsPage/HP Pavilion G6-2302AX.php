...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/HP.php" title="HP">HP</a> / <a href="../LaptopsPage/HP Pavilion G6-2302AX.php" title="HP">HP Pavilion G6-2302AX</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/hp19_1.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u> HP Pavilion G6-2302AX</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/hp19_2.jpg" height="200" width="130" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/hp19_3.jpg" height="200" width="200" onmousemove="showT(src)" />
					  &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/hp19_1.jpg" height="150" width="200" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <strong>
      <h2>Specifications of HP PAVILION G6-2302AX&nbsp;(Imprint Sparkling Black)</h2>
      </strong></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <table width="865" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="551">APU Dual Core A4</td>
                        </tr>
                        <tr>
                          <td>Variant</td>
                          <td>4300M</td>
                        ...
                        <tr>
                          <td>Clock Speed</td>
                          <td>2.5 GHz with Turbo Core Technology&nbsp;Upto&nbsp;3 GHz</td>
                        </tr>
						<tr>
                          <td>Cache</td>
                          <td>1 MB</td>
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="554">SuperMulti&nbsp;DVD RW Drive with Dual Layer Support</td>
                        </tr>
					  </tbody>
       </table>
                   ...
                   <br /><br />
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td>Screen Type</td>
                          <td>HD&nbsp;Brightview&nbsp;Widescreen LED Backlit Display</td>
                        </tr>
                      </tbody>
       </table>
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="554">512 MB AMD Radeon HD 7420G (Integrated) and 1 GB ATI Mobility Radeon HD 7670M (Dedicated)</td>
                        </tr>
                   ...
                   <br /><br />
                    <table width="873" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td>Keyboard</td>
                          <td>Full-size Textured Island Keyboard</td>
                        </tr>
                      </tbody>
       </table>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
						...
						<tr>
                          ...
                          <td width="556">Integrated 10/100</td>
                        </tr>
                        <tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557">375.92 x 244.09 x 36.32 mm</td>
                        </tr>
						<tr>
                          <td width="297">Weight</td>
                          <td width="557">2.47 kg </td>
                        </tr>
                      </tbody>
       </table>
