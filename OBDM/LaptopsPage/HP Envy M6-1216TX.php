...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/HP.php" title="HP">HP</a> / <a href="../LaptopsPage/HP Envy M6-1216TX.php" title="HP">HP Envy M6-1216TX</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/hp10_1.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u>HP Envy M6-1216TX</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/hp10_2.jpg" height="150" width="200" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/hp10_3.jpg" height="150" width="200" onmousemove="showT(src)" />
					 &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/hp10_4.jpg" height="150" width="200" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <strong>
      <h2>Specifications of HP ENVY M6-1216TX Laptop (Aluminium Finish Natural Silver)</h2>
      <br />
				    <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			        ...
			        <table width="865" cellspacing="5">
		              <tbody>
                        ...
                        <tr>
                          <td>Color</td>
                          <td>Aluminium Finish Natural Silver</td>
                        </tr>
                        <tr>
                          <td>Part Number</td>
                          <td>D9H73PA</td>
                    ...
                    <table width="865" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td>Clock Speed</td>
                          <td>2.5 GHz with Turbo Boost&nbsp;Upto&nbsp;3.2 GHz</td>
                        </tr>
						<tr>
                          <td>Cache</td>
                          <td>6 MB</td>
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557">SuperMulti&nbsp;DVD RW Drive with Dual Layer Support</td>
                        </tr>
					  </tbody>
       </table>
                   ...
                   <br /><br />
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td>Screen Type</td>
                          <td>HD LED&nbsp;BrightView&nbsp;Backlit Display</td>
                        </tr>
                      </tbody>
       </table>
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557">AMD Mobility Radeon HD 7670M</td>
                        </tr>
						 <tr>
	     ...
	     <br /><br />
                    <table width="875" cellspacing="5">
                      <tbody>
						...
						<tr>
                          <td>Sound</td>
                          <td>HD Audio, Beats Audio with High Quality Sound, Dual Speakers with Internal Subwoofer</td>
                        </tr> 
