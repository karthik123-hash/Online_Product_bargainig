...
<head>
	...
	<?php 
		 error_reporting(E_ALL ^ E_NOTICE);     //      To erase the Notice because the variables below first used in this scope
		  ...
		  $Barg=$_SESSION['barg'];
		  $_SESSION['pname']=$pn;
		  if($pn!="Lenovo Ideapad Yoga 13 (59-369597) Ultrabook")
...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/Lenovo.php" title="Dell">Lenovo</a> / <a href="../LaptopsPage/Lenovo Ideapad Yoga 13 (59-369597) Ultrabook.php" title="Dell">Lenovo&nbsp;Ideapad&nbsp;Yoga 11S (59-369150) Netbook&nbsp;</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/len9_1.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u> Lenovo&nbsp;Ideapad&nbsp;Yoga 13 (59-369597)&nbsp;Ultrabook</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/len9_2.jpg" height="180" width="200" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/len9_3.jpg" height="180" width="200" onmousemove="showT(src)" />
					 &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/len9_4.jpg" height="180" width="200" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <strong>
      <h2>Specifications of LENOVO IDEAPAD YOGA 13 (59-369597) ULTRABOOK&nbsp;(Silver Grey)</h2>
      </strong></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   ...
                   <br /><br />
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td>Screen Type</td>
                          <td>HD Plus IPS Display with Wide Viewing Angle and 10 Point Multi-touch</td>
                        </tr>
                      </tbody>
       </table>
