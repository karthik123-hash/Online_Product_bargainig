...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../LMENU/HP.php" title="HP">HP</a> / <a href="../LaptopsPage/HP Envy 4-1201TX.php" title="HP">HP Envy 4-1201TX</a><br />
			<br /><br />
					<img id="Main" src="../css/images/laptop/hp8_1.jpg" height="280" width="300" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u>HP Envy 4-1201TX</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/laptop/hp8_2.jpg" height="150" width="200" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/laptop/hp8_1.jpg" height="150" width="200" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <strong>
      <h2>Specifications of HP ENVY 4-1201TX ULTRABOOK</h2>
      <br />
				    <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			        ...
			        <table width="865" cellspacing="5">
		              <tbody>
                        ...
                        <tr>
                          <td>Color</td>
                          <td>Aluminium&nbsp;Finish Midnight Black With Soft Touch Ruby Red Vertical Brushing Pattern</td>
                        </tr>
                        <tr>
                          <td>Part Number</td>
                          <td>C9M38PA</td>
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557">AMD Mobility Radeon HD 8750M</td>
                        </tr>
						 <tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="562">339.85 x 235.71 x 19.81 mm</td>
                        </tr>
						<tr>
                          <td width="292">Weight</td>
                          <td width="562">1.75 kg </td>
                        </tr>
                      </tbody>
       </table>
