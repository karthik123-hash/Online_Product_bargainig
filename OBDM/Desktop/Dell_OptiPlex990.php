...
<!-- Begin Wrapper -->
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../DMENU/Dell.php" title="Dell">Dell</a> / <a href="#" title="Dell OptiPlex990">Dell OptiPlex990</a><br />
			<br /><br />
			<img id="Main" src="../css/images/desktop/dell_OptiPlex_990.jpg" height="380" width="350" align="left"/>
		  <div class="effect2"> <span class="style10"><u>Dell OptiPlex 990</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/desktop/dell_OptiPlex_990.jpg" height="120" width="120" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
			  <img src="../css/images/desktop/dell_OptiPlex_990_a.jpg" height="120" width="120" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <span class="style12">Specifications of Dell Inspiron 990s</span></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	 ...
	 <div class="effect">
		            ...
		            <table width="865" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td>Chipset</td>
                          <td>Intel Q67 Express Chipset  </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td>Genuine Windows 7 Professional 32-Bit   </td>
                        </tr>
                        <tr>
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="559">Up to 32GB SATA hard drive  </td>
                        </tr>
						<tr>
                  ...
                  <br /><br />
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="297">USB</td>
                          <td width="557">10 External USB 2.0 ports, 1 Internal USB 2.0 for </td>
                        </tr>
