...
<body>
	...
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../DMENU/Lenovo.php" title="Lenovo">Lenovo</a> / <a href="#" title="Lenovo IdeaCentre">Lenovo IdeaCentre B320 </a><br />
			<br /><br />
			<img id="Main" src="../css/images/desktop/b320-57307776-a.jpeg" height="380" width="350" align="left"/>
			<div class="effect2"> <span class="style10"><u>Lenovo IdeaCentre B320 (57-307776)</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/desktop/b320-57307776-a.jpeg" height="120" width="120" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
			  <img src="../css/images/desktop/B320-57307776-A.jpg" height="120" width="120" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <span class="style12">Specifications of Lenovo IdeaCentre B320 (57-307776)</span>
                  ...
                  <br /><br />
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="297">USB</td>
                          <td width="557"> 2 x USB 2.0 (Side), 4 x USB 2.0 (Rear)</td>
                        </tr>
						<tr>
                          <td>Bluetooth</td>
                          <td> 	Yes</td>
	   ...
	   <br /><br />
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td>Keyboard</td>
                          <td>Wireless Keyboard with India Rupee Symbol</td>
                        </tr>
