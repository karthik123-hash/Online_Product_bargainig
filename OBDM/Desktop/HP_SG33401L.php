...
<!-- Begin Wrapper -->
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../DMENU/HP.php" title="HP">HP</a> / <a href="#" title="HP-Compaq">HpCompaq</a><br />
			<br /><br />
			<img id="Main" src="../css/images/desktop/Hp_presario-sg3340il_a.jpg" height="380" width="350" align="left"/>
		  <div class="effect2"> <span class="style10"><u>HP Compaq Presario SG3340IL</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/desktop/Hp_presario-sg3340il_a.JPG" height="120" width="120" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
			  <img src="../css/images/desktop/Hp_presario-sg3340il.jpg" height="120" width="120" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <span class="style12">Specifications of HP Compaq Presario SG3340IL</span></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	 ...
	 <div class="effect">
			        <table width="865" cellspacing="5">
		              <tbody>
                        ...
                        <tr>
                          <td>Model Name </td>
                          <td>Compaq Presario SG3340IL</td>
                        </tr>
                        <tr>
                          <td>Series</td>
                          <td>Compaq</td>
		            ...
		            <table width="865" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>Pentium Dual Core Processor E2160 </td>
                        </tr>
                        <tr>
                          <td>Chipset</td>
                    ...
                    <table width="873" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="559">SuperMulti SATA </td>
                        </tr>                 
                  ...
                  <br /><br />
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="297">USB</td>
                          <td width="557">6 USB 2.0 ports (2 front, 4 rear), 2 PS/2, LAN </td>
                        </tr>
						 <tr>
                          <td>eSATA</td>
                          <td>YES</td>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557"> Compaq Optical, 2-button PS2 scroller mouse </td>
                        </tr>
                        </tr>
                        <tr>
                          <td>Keyboard</td>
