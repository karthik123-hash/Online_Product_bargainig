...
<body>
	...
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../DMENU/Lenovo.php" title="Lenovo">Lenovo</a> / <a href="#" title="Lenovo Essential">Lenovo EssentialC200</a>  <br />
			<br /><br />
			<img id="Main" src="../css/images/desktop/C200(57-308053).jpeg" height="380" width="350" align="left"/>
			<div class="effect2"> <span class="style10"><u>Lenovo Essential C200 (57-308053)</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/desktop/C200(57-308053).jpeg" height="120" width="120" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
			  <img src="../css/images/desktop/c200(57-308053).jpg" height="120" width="120" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <span class="style12">Specifications of Lenovo Essential C200  (57-308053)</span>
	 ...
	 <div class="effect">
                    ...
                    <table width="865" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>Atom Dual Core(ist generation) </td>
                        </tr>
						 <tr>
                          <td>Chipset</td>
                          <td>NM10 Express</td>
					...
					<table width="871" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="294">Expandable Memory</td>
                          <td width="556">Upto 4 GB</td>
                        </tr>
                        <tr>
                          <td>System Memory</td>
                          <td> 	2 GB DDR3</td>
                  ...
                  <br /><br />
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="294">Speaker output</td>
                          <td width="557">3W 3W</td>
                        </tr>                                            
                  ...
                  <br /><br />
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="297">USB</td>
                          <td width="557">  	USB 2.0 x 2 (Side), USB 2.0 x 3 (Rear)</td>
                        </tr>
                        </tr>
                        <tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="563">1 Year Lenovo Warranty and Free Transit Insurance</td>
                        </tr>
                      </tbody>
       </table>
                    <p>&nbsp;</p>
