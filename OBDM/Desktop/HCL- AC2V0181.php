...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../DMENU/HCL.php" title="HCL">HCL</a> / <a href="#" title="HCL Ezeebee AC2V0181">Hcl EzeebeeAC2V0181</a><br />
			<br /><br />
			<img id="Main" src="../css/images/desktop/HCL-Ezeebee-AC2V0181.jpg" height="380" width="350" align="left"/>
		  <div class="effect2"> <span class="style10"><u>HCL Ezeebee AC2V0181</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/desktop/HCL-Ezeebee-AC2V0181.jpg" height="120" width="120" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
			  <img src="../css/images/desktop/HCL-Ezeebee-AC2V0181_a.jpg" height="120" width="120" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <span class="style12">Specifications of HCL Ezeebee AC2V0181 </span></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<table width="871" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="556">2 GB DDR3 IIIRAM</td>
                        </tr>
                        <tr>
                          <td>Memory Detail</td>
                          <td> DDR3</td>
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557"> 	Intel HD Graphics,shared with memory</td>
                        </tr>
						<tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557"> 	HCL 3 Button with Scroll Optical USB Mouse</td>
                        </tr>
                        </tr>
                        <tr>
                          <td>Keyboard</td>
                          <td>HCL 104 keys PS/2 Keyboard</td>
                        </tr>
