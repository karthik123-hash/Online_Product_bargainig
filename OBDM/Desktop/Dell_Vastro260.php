...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../DMENU/Dell.php" title="Dell">Dell</a> / <a href="#" title="Dell Vastro260">Dell Vastro260</a><br />
			<br /><br />
			<img id="Main" src="../css/images/desktop/dell-vostro-260s.jpg" height="380" width="350" align="left"/>
		  <div class="effect2"> <span class="style10"><u>Dell Vostro 260s Slim Tower</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/desktop/dell-vostro-260s.jpg" width="120" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
			  <img src="../css/images/desktop/dell-vostro-260s_b.png" height="120" width="120" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <span class="style12">Specifications of Dell Vostro 260s Slim Tower</span></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		            ...
		            <table width="865" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>Intel Pentium Processor G630  </td>
                        </tr>
                        <tr>
                          <td>Chipset</td>
                          <td>Intel 6 Series H61 Chipset  </td>
                        </tr>
                        <tr>
                  ...
                  <br /><br />
                    <table width="872" cellspacing="5">
                      <tbody>
						...
						<tr>
						<td>Audio card</td>
						<td>Three back-panel connectors for line-in, line-out, microphone-in, two front-panel connectors for headphone-output and microphone-in </td>
						</tr>                                                
                      </tbody>
       </table>
                    ...
                    <table width="873" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="559">16X CD/DVD burner (DVD+/-RW) with double layer write capability </td>
                        </tr>                 
                  ...
                  <br /><br />
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="297">USB</td>
                          <td width="557">8 External USB 2.0 ports, 2 Internal USB 2.0 port </td>
                        </tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557"> Dell USB Optical Mouse, Dell Laser Mouse  </td>
                        </tr>
                        </tr>
                        <tr>
                          <td>Keyboard</td>
                          <td>Dell USB Entry Keyboard, Dell Multimedia Pro Keyboard </td>
                        </tr>
