...
<!-- Begin Wrapper -->
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../DMENU/Lenovo.php" title="Lenovo">Lenovo</a> / <a href="#" title="Lenovo Essential">Lenovo Essential C440</a><br />
			<br /><br />
			<img id="Main" src="../css/images/desktop/c440 all.jpg" height="380" width="350" align="left"/>
			<div class="effect2"> <span class="style10"><u>Lenovo Essential C440</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/desktop/c440 all.jpg" height="120" width="120" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
			  <img src="../css/images/desktop/c440_a.jpeg" height="120" width="120" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <span class="style12">Specifications of Lenovo Essential C440</span></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <table width="865" cellspacing="5">
                      <tbody>
						...
						<tr>
                          ...
                          <td> 	3 GHz with Turbo Boost Upto 3.2 GHz</td>
                        </tr>
                        <tr>
                    ...
                    <table width="870" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>Widescreen, 16:9 Aspect Ratio for Cinematic Movie Viewing with Less Eye Strain </td>
                        </tr>
                      </tbody>
       </table>
					<br /><br />					
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        <tr>
                         ...
                         <tr>
                          <td width="299">Sensor resolution</td>
                          <td width="552">720p HD Webcam megapixel</td>
                        </tr>
                        <tr>
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557">Two Integrated High Volume Stereo Speakers</td>
                        </tr>                                            
	   ...
	   <br /><br />
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td>Keyboard</td>
                          <td>Wireless Keyboard with India Rupee Symbol(2.4 GHz Range)</td>
                        </tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="563">2 Year Warranty </td>
                        </tr>
                      </tbody>
       </table>
                    <p>&nbsp;</p>
