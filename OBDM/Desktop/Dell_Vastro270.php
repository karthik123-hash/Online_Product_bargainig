...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../DMENU/Dell.php" title="Dell">Dell</a> / <a href="#" title="Dell Vastro 270">Dell Vastro270</a><br />
			<br /><br />
			<img id="Main" src="../css/images/desktop/dell-vostro-270_b.jpg" height="380" width="350" align="left"/>
		  <div class="effect2"> <span class="style10"><u>Dell Vostro 270s Slim Tower</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/desktop/dell-vostro-270_b.jpg" height="120" width="120" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
			  <img src="../css/images/desktop/dell-vostro-270_a.jpg" height="120" width="120" onmousemove="showT(src)" />
                  ...
                  <br /><br />
                    <table width="872" cellspacing="5">
                      <tbody>
						...
						<tr>
						<td>Audio card</td>
						<td>3-stack audio jacks supporting 5.1 surround sound </td>
						</tr>                                                
                      </tbody>
       </table>
                  ...
                  <br /><br />
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="297">USB</td>
                          <td width="557">Back : (2) USB 3.0, (4) USB 2.0, HDMI, VGA, RJ-45 (10/100/1000 Ethernet), 3-stack audio jacks supporting 5.1 surround sound
