	...
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			...
			<br /><br />
			<img id="Main" src="../css/images/desktop/c320(57-307840)_b.jpeg" height="380" width="350" align="left"/>
			<div class="effect2"> <span class="style10"><u>Lenovo Essential C320 (57-307840)</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/desktop/c320(57-307840)_b.jpeg" height="120" width="120" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
			  <img src="../css/images/desktop/c320(57-307840)_c.jpg" height="120" width="120" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <span class="style12">Specifications of Lenovo Essential C320  (57-307840)</span>
	 ...
	 <div class="effect">
					...
					<table width="871" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="294">Memory speed</td>
                          <td width="556">1066MT/s</td>
                        </tr>
                        <tr>
                          <td>System Memory</td>
                          <td> 	2 GB DDR3</td>
                    ...
                    <table width="870" cellspacing="5">
                      <tbody>
                        <tr>
                          <th colspan="2" align="justify"><span class="style15">Graphics</span></th>
                        </tr>
                       
                        <tr>
                          <td width="294">Integrated Graphic Processor</td>
                          <td width="555">Intel HD Graphics</td>
                        </tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="563">1 Year Lenovo Warranty </td>
                        </tr>
                      </tbody>
       </table>
                    <p>&nbsp;</p>
