...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../DMENU/Dell.php" title="Dell">Dell</a> / <a href="#" title="Dell OptiPlex390">Dell OptiPlex390</a><br />
			<br /><br />
			<img id="Main" src="../css/images/desktop/dell_OptiPlex_390.jpg" height="380" width="350" align="left"/>
		  <div class="effect2"> <span class="style10"><u>Dell OptiPlex 390</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/desktop/dell_OptiPlex_390.jpg" height="120" width="120" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
			  <img src="../css/images/desktop/dell_OptiPlex_390_a.jpg" height="120" width="120" onmousemove="showT(src)" />
	 ...
	 <div class="effect">
		            ...
		            <table width="865" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td>Chipset</td>
                          <td>Intel H61 Express Chipse  </td>
                        </tr>
                        <tr>
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="559">Up to 250GB SATA hard drive  </td>
                        </tr>
						<tr>
