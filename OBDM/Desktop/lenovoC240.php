	...
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			...
			<br /><br />
			<img id="Main" src="../css/images/desktop/C240_c.jpg" height="380" width="350" align="left"/>
			<div class="effect2"> <span class="style10"><u>Lenovo Essential C240 (Black)</u></span>
					<br/><br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/desktop/C240_c.JPG" height="120" width="120" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
			  <img src="../css/images/desktop/C240_a.jpg" height="120" width="120" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <span class="style12">Specifications of Lenovo Essential C240  (Black)</span>
	 ...
	 <div class="effect">
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="293">Video Size</td>
                          <td width="558">1280x720pixel</td>
                        </tr>
                        <tr>
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557">Rich and Realistic Sound Dolby Surround sound V2</td>
                        </tr>
                        <tr>
	   ...
	   <br /><br />
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td>Keyboard</td>
                          <td>Wired AccuType Keyboard with India Rupee Symbol</td>
                        </tr>
                        <tr>
                          <td>Memory Card Reader</td>
                          <td>6-in-1 card Reader</td>
