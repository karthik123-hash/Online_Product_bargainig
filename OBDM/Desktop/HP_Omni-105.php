...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../DMENU/HP.php" title="HP">HP</a> / <a href="#" title="HP-Omni">HpOmni</a><br />
			<br /><br />
			<img id="Main" src="../css/images/desktop/HP-Omni-105-5520.jpg" height="380" width="350" align="left"/>
		  <div class="effect2"> <span class="style10"><u>HP Omni 105-5520IX All-in-One </u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/desktop/HP-Omni-105-5520.JPG" height="120" width="120" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
			  <img src="../css/images/desktop/hp-omni-105-5520-a.jpg" height="120" width="120" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <span class="style12">Specifications of HP Omni 105-5520IX All-in-One </span></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	 ...
	 <div class="effect">
		            ...
		            <table width="865" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>Pentium Dual Core (2nd Generation)</td>
                        </tr>
                        <tr>
                          <td>Chipset</td>
                          <td>B65 Express</td>
                    ...
                    <table width="870" cellspacing="5">
                      <tbody>
						...
						<td>HD Display, Anti-glare Widescreen Display (50.8 cm), Brightness: 250 nits, Aspect Ratio: 16:9</td>
						</tr>
                      </tbody>
       </table>
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="558">0.3 Megapixel megapixel</td>
                        </tr>
                    ...
                    <table width="873" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="559">Slim Tray SuperMulti DVD RW Drive</td>
                        </tr>
						<tr>                 
                            <td> Maximum Read speed</td>
							<td> DVD: DVD-ROM (SL)-8x, DVD-ROM (DL)-6x, DVD-RAM-5x, CD: CD-ROM-24x, CD-R-24x, CD-RW-24x</td>
						</tr>
							<tr>
							 <td>Maximum Write speed</td>
							  <td>DVD: DVD+R (SL)-8x, DVD-R (SL)-8x, DVD+R (DL)-6x, DVD-R (DL)-6x, DVD+RW (SL)-8x, DVD-RW (SL)-6x, DVD-RAM-5x, CD: CD-R-24x, CD-RW-24x</td>
							</tr>        
                      </tbody>
       </table>
                  ...
                  <br /><br />
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="297">USB</td>
                          <td width="557">USB 2.0 x 2 (Side), USB 2.0 x 4 (Rear)</td>
                        </tr>
						<tr>
						<td>Memory Stick Slot</td>
						<td>Secure Digital (SD), Secure Digital High Capacity (SDHC), MultiMedia Card (MMC), xD Picture Card (xD), Memory Stick (MS), Memory Stick Pro</td>
						</tr>
						<tr>
                          <td>Bluetooth</td>
                          <td>Yes, v4.0 HS</td>
						...
						<tr>
						<td>PCI Slot</td>
						<td>1 x PCI Express x16 (Gen 2.0), 1 x PCI Express Half-size Mini Card Socket (Gen 2.0)</td>
						</tr>
                        <tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="563">3 Years Onsite Warranty</td>
                        </tr>
