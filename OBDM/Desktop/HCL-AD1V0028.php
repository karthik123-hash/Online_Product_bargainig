...
<link rel="shortcut icon" href="../css/images/favicon.ico" />
	...
	<?php 
		 error_reporting(E_ALL ^ E_NOTICE);     //      To erase the Notice because the variables below first used in this scope
		  ...
		  $_SESSION['pname']=$pn;
		  if($pn!="HCL AD1V0028")
		  header("Location: http://localhost/OBDM/DMENU/HCL.php");
...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../DMENU/HCL.php" title="HCL">HCL</a> / <a href="#" title="HCL Beanstalk AD1V0028">HclBeanstalk AD1V0028</a><br />
			<br /><br />
			<img id="Main" src="../css/images/desktop/hcl-beanstalk-ad1v0028.jpg" height="380" width="350" align="left"/>
		  <div class="effect2"> <span class="style10"><u>HCL Beanstalk AD1V0028</u></span><br/>
					<br /><br/><br />
					<p>
					
				<strong>1 Year HCL Warranty and Free Transit Insurance. </strong><br />  
				<br />
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/desktop/HCL-Beanstalk-AD1V0028.jpg" width="120" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
			  <img src="../css/images/desktop/hcl-beanstalk-ad1v0028_a.jpg" height="120" width="120" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <span class="style12">Specifications of HCL Beanstalk AD1V0028</span>      </div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557"> 	Intel HD Graphics 3000</td>
                        </tr>
                      </tbody>
       </table>
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557"> 2 x 3 W Hi-Fi Integrated Stereo Speaker</td>
                        </tr>
						<tr>
                    ...
                    <table width="873" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="559">Slim Type ODD Bay</td>
                        </tr>                 
                  ...
                  <br /><br />
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="297">USB</td>
                          <td width="557"> 	USB 2.0 x 3, USB 3.0 X 2</td>
                        </tr>
						<tr>
						<td>HeadPhone Jack</td>
						<td> 	Stereo, Mini Jack x 1</td>
                        </tr>
						<tr>
						<td>PCI Slot</td>
						<td>1 PCI Express Mini Card Slot</td>
						</tr>
                        <tr>
                          <td>HDMI</td>
                          <td>HDMI In x 1</td>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557"> 	Wired Optical Mouse</td>
                        </tr>
                        </tr>
                        <tr>
                          <td>Keyboard</td>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="563">1 Year HCL Warranty and Free Transit Insurance.</td>
                        </tr>
                      </tbody>
       </table>
                    <p>&nbsp;</p>
