...
<!-- Begin Wrapper -->
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../DMENU/Lenovo.php" title="Lenovo">Lenovo</a> / <a href="#" title="Lenovo Essential">Lenovo Essential C340</a><br />
			<br /><br />
			<img id="Main" src="../css/images/desktop/c340-57-310129-a.jpeg" height="380" width="350" align="left"/>
			<div class="effect2"> <span class="style10"><u>Lenovo Essential C340 (57-310129)</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/desktop/c340-57-310129-a.jpeg" height="120" width="120" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
			  <img src="../css/images/desktop/C340_b.jpg" height="120" width="120" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <span class="style12">Specifications of Lenovo Essential C340  (57-307109)</span>
                    ...
                    <table width="870" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>Widescreen, Lenovo Eye Distance System, Lenovo Dynamic Brightness </td>
                        </tr>
                      </tbody>
       </table>
					<br /><br />					
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557">Bulit-in Speaker</td>
                        </tr>                                            
