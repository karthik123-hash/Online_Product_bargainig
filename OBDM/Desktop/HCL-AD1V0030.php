...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			...
			<br /><br />
			<img id="Main" src="../css/images/desktop/hcl-beanstalk-ad1v0030_a.jpeg" height="380" width="350" align="left"/>
		  <div class="effect2"> <span class="style10"><u>HCL Beanstalk AD1V0030</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/desktop/hcl-beanstalk-ad1v0030_a.jpeg" height="120" width="120" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
			  <img src="../css/images/desktop/hcl-beanstalk-ad1v0030.jpg" height="120" width="120" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <span class="style12">Specifications of HCL Beanstalk AD1V0030</span></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
