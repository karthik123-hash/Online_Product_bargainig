...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../DMENU/HCL.php" title="HCL">HCL</a> / <a href="#" title="HCL Ezeebee">HclEzeebee</a><br />
			<br /><br />
			<img id="Main" src="../css/images/desktop/HCL-Ezeebee-AC2V0140_a.jpg" height="380" width="350" align="left"/>
		  <div class="effect2"> <span class="style10"><u>HCL Ezeebee AC2V0140</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/desktop/HCL-Ezeebee-AC2V0140_a.jpg" height="120" width="120" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
			  <img src="../css/images/desktop/HCL-Ezeebee-AC2V0140.jpeg" height="120" width="120" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <span class="style12">Specifications of HCL Ezeebee AC2V0140 </span></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
