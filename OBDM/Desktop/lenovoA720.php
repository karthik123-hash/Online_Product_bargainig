...
<body>
	...
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../DMENU/Lenovo.php" title="Lenovo">Lenovo</a> / <a href="#" title="Lenovo IdeaCentre">Lenovo IdeaCentre A720 </a><br />
			<br /><br />
			<img id="Main" src="../css/images/desktop/a720-57-306177.jpeg" height="380" width="350" align="left"/>
			<div class="effect2"> <span class="style10"><u>Lenovo IdeaCentre A720 (57-316177)</u></span><br/>
					<br /><br/><br />
					<p>
					
				<strong>3 year manufacturer warranty </strong><br />  
				<br />
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/desktop/a720-57-306177.jpeg" height="120" width="120" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
			  <img src="../css/images/desktop/a720-57-306177_b.jpeg" height="120" width="120" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <span class="style12">Specifications of Lenovo IdeaCentre A720 (57-306177)</span>
	 ...
	 <div class="effect">
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="294">Dedicated Graphic Memory 	</td>
                          <td width="557">1 GB</td>
                        </tr>
                        <tr>
                          <td>Dedicated Graphic Processor</td>
                          <td>NVIDIA GT 630M</td>
                        </tr>
						<tr>
                          <td>Integrated Graphic Processor</td>
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="299">Built-in WebCam</td>
                          <td width="552">Yes</td>
                        </tr>
                        <tr>
                  ...
                  <br /><br />
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="294">Built-in Microphone</td>
                          <td width="557"> 	Yes</td>
                        </tr>
						<tr>
                          <td>Other Audio features</td>
                          <td>Integrated Dolby V4 Speaker System</td>
                        </tr>                                                         
                   ...
                   <br /><br />
                    <table width="873" cellspacing="5">
                      <tbody>
                        <tr>
                           <th colspan="2" align="justify"><span class="style13">TV Support</span></th>
                        </tr>
                        <tr>
                          <td width="293">TV Tuner </td>
                          <td width="559">No</td>
                        </tr>
                  ...
                  <br /><br />
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="297">USB</td>
                          <td width="557"> USB 3.0 x 2, USB 2.0 x 2 </td>
                        </tr>
						<tr>
                          <td>Bluetooth</td>
                          <td> 	Yes</td>
                        ...
                        <tr>
						 ...
						 <tr>
                          <td>HDMI</td>
                          <td> 	HDMI In x 1, HDMI Out x 1</td>
                        </tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557"> 	Wirelesss  Mouse</td>
                        </tr>
                        </tr>
                        <tr>
                          <td>Keyboard</td>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="563">3 Year Warranty </td>
                        </tr>
                      </tbody>
       </table>
                    <p>&nbsp;</p>
