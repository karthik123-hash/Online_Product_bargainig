...
<!-- Begin Wrapper -->
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../DMENU/Dell.php" title="Dell">Dell</a> / <a href="#" title="Dell Inspiron560">Dell Inspiron560</a><br />
			<br /><br />
			<img id="Main" src="../css/images/desktop/Dell_Inspiron_560s.png" height="380" width="350" align="left"/>
		  <div class="effect2"> <span class="style10"><u>Dell Inspiron 560s Slim Desktop (T260504In8)</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/desktop/dell-inspiron-535s.jpg" height="120" width="120" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
			  <img src="../css/images/desktop/Dell_Inspiron_560s_a.jpg" height="120" width="120" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <span class="style12">Specifications of Dell Inspiron 560s Slim Desktop (T260504In8) </span></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		            ...
		            <table width="865" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>Windows 7 Professional/Home Basic/Premium64-Bit  </td>
                        </tr>
                        <tr>
                          <td>Processor Model</td>
                          <td>DELL Inspiron 560 </td>
                        </tr>
                      </tbody>
                    </table>
		            <br />
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557">Intel Graphics Card</td>
                        </tr>
						<tr>
