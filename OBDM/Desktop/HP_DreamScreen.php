...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../DMENU/HP.php" title="HP">HP</a> / <a href="#" title="HP DreamScreen">HP DreamSreen</a><br />
			<br /><br />
			<img id="Main" src="../css/images/desktop/hp-dreamscreen.jpeg" height="380" width="350" align="left"/>
		  <div class="effect2"> <span class="style10"><u>HP DreamScreen 400 All-in-One </u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/desktop/hp-dreamscreen.jpeg" height="120" width="120" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
			  <img src="../css/images/desktop/hp-dream-screen-400.jpg" height="120" width="120" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <span class="style12">Specifications of HP DreamScreen 400 All-in-One </span></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		            ...
		            <table width="865" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>Atom Dual Core (1st Generation)</td>
                        </tr>
                        <tr>
                          <td>Chipset</td>
                          <td>NM10 Express</td>
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="557">  	Intel Onboard Graphics</td>
                        </tr>
						<tr>
                  ...
                  <br /><br />
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td width="297">USB</td>
                          <td width="557">USB 2.0 ports x 4</td>
                        </tr>
						<tr>
                    ...
                    <table width="875" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="563">1 Year HP Warranty and Free Transit Insurance..</td>
                        </tr>
