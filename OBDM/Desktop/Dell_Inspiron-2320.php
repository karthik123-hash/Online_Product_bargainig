...
<body>
	...
	<div id="wrapper">
	  ...
	  <div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../DMENU/Dell.php" title="Dell">Dell</a> / <a href="#" title="Dell Inspiron2320">Dell Inspiron2320</a><br />
			<br /><br />
			<img id="Main" src="../css/images/desktop/dell-inspiron-one-2320.jpg" height="380" width="350" align="left"/>
		  <div class="effect2"> <span class="style10"><u>Dell Inspiron One 2320 (i3/6GB/1TB) All in One</u></span><br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/desktop/dell-inspiron-one-2320.jpg" height="120" width="120" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
			  <img src="../css/images/desktop/dell-inspiron-one-2320-b.jpg" height="120" width="120" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <span class="style12">Specifications of Dell Inspiron One 2320 (i3/6GB/1TB) All in One </span></div>
				    <br />
				    <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		            ...
		            <table width="865" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>Genuine Windows(R) 7 Home Premium SP1 64 bit (English) w/MUI </td>
                        </tr>
                        <tr>
