...
<body>
	...
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../MENU/Nokia.php" title="Nokia">Nokia</a> / <a href="#" title="Nokia Asha 303">Nokia Asha 303</a><br />
			<br /><br />
					<img src="../css/images/Mobile/nkasha30three0.jpeg" name="Main" width="196" height="400" align="left" id="Main"/>
					
		  <div class="effect2"> <span class="style10"><u> Nokia Asha 303 (Graphite)</u></span>
					<br/><br /><br/><br />
					<p>
			  ...
			  &nbsp;&nbsp;<img src="../css/images/Mobile/nkasha30three0.jpeg" height="142" width="69" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/Mobile/nkasha30three3.jpeg" height="146" width="71" onmousemove="showT(src)" />&nbsp;&nbsp;&nbsp;
					  <img src="../css/images/Mobile/nkasha30three2.jpeg" height="146" width="71" onmousemove="showT(src)" />&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <span class="style12">Specifications of  Nokia Asha 303 (Graphite)</span>
	 ...
	 <div class="effect">
      ...
      <td width="551">Handset, Battery, Charger, Headset, User Guide</td>
    </tr>
    <tr>
      <td>Brand</td>
      <td>Nokia</td>
    ...
    <tr>
      <td>Call Features</td>
      <td>Conference Call, Speed Dialing, Loudspeaker</td>
    </tr>
    <tr>
      <td>Handset Color</td>
      <td>Graphite</td>
    ...
    <tr>
      ...
      <td>Fixed Focus, Image Editor</td>
    </tr>
                      </tbody>
       </table>
      ...
      <td width="558">55.7x116.5x13.9 mm</td>
    </tr>
    <tr>
      <td>Weight</td>
      <td>99 g</td>
      ...
      <td width="558">Li-Ion, 1300 mAh</td>
    </tr>
    <tr>
      <td>Talk Time</td>
      <td>8 hrs (2G), 7 hrs (3G)</td>
    </tr>
    <tr>
      <td>Standby Time</td>
      <td>720 hrs (2G), 840 hrs (3G)</td>
    </tr>
                      </tbody>
       </table>
    ...
    <tr>
      <td>3G</td>
      <td>Yes, 10.2 Mbps HSDPA; 2 Mbps HSUPA</td>
    </tr>
    <tr>
      <td>Wifi</td>
      <td>Yes, 803.11 b/g/n</td>
    </tr>
    <tr>
      <td>WAP</td>
      <td>Yes, v2</td>
    ...
    <tr>
      <td>Bluetooth</td>
      <td>Yes,   v2.1, Supported Profiles (A2DP, AVRCP 1.0, DUN, FTP, GAP, GAVDP, GOEP,   HFP, HSP, OPP, PAN, PBAP 1.0, SAP, SDAP, SPP 1.0, EDR)</td>
    </tr>
    <tr>
      <td>Audio Jack</td>
      <td>3.5 mm</td>
      ...
      <td width="559">Yes, Supports MP3, WAV, eAAC, MIDI</td>
    </tr>
    <tr>
      <td>Video Player</td>
      <td>Yes, Supports 3GPP, MPEG-4, H.263, WMV</td>
    </tr>
    <tr>
      <td>FM</td>
      <td>Yes</td>
    ...
    <tr>
      ...
      <td>Detailed   Contact Information, Calendar, To-do List, Notes, Voice Recorder,   Clock, Calculator, Alarm Clock, Countdown Time, Stopwatch, Wallpapers,   Screen Saver, Macromedia Flash Lite 3.0, Video Streaming</td>
    </tr>
    <tr>
      <td>Important Apps</td>
      <td>Facebook, Twitter, Flickr, Orkut</td>
    </tr>
                      </tbody>
       </table>
