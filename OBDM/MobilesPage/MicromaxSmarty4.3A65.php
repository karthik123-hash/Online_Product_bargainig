...
<body>
	...
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../MENU/Micromax.php" title="Micormax">Micromax</a> / <a href="#" title="Micromax Smarty 4.3 A65">Micromax Smarty 4.3 A65</a><br />
			<br /><br />
					<img src="../css/images/Mobile/mmsmartya0.jpeg" name="Main" width="172" height="380" align="left" id="Main"/>
					
		  <div class="effect2"> <span class="style10"><u>Micromax Smarty 4.3 A65 (White)</u></span>
					<br/>
					<br /><br/><br />
					<p>
			  ...
			  &nbsp;&nbsp;<img src="../css/images/Mobile/mmsmartya0.jpeg" height="142" width="69" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/Mobile/mmsmartya1.jpeg" height="146" width="71" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <span class="style12">Specifications of Micromax Smarty 4.3 A65 (White)</span>
	 ...
	 <div class="effect">
      ...
      <td width="550">Handset, Charger, Headset, Battery, User Guide, Data Cable, Warranty Card, Protective Cover</td>
    </tr>
    <tr>
      <td>Brand</td>
      <td>Micromax</td>
    ...
    <tr>
      <td>OS</td>
      <td>Android v2.3.5 (Gingerbread)</td>
    </tr>
    <tr>
      <td>Processor</td>
      <td>1 GHz ARM Cortex-A5</td>
    </tr>
                      </tbody>
       </table>
    ...
    <tr>
      ...
      <td width="556">Yes, 2 Megapixel</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>CMOS Sensor, Flash Support, Fixed Focus, Multi-shot Mode, Night Vision, Brightness Level, Image Editor</td>
    </tr>
                      </tbody>
       </table>
      ...
      <td width="557">69.7x130x10.95 mm</td>
    </tr>
    <tr>
      <td>Weight</td>
      <td>148 g</td>
      ...
      <td width="561">Li-Ion, 1350 mAh</td>
    </tr>
    <tr>
      <td>Talk Time</td>
      <td>5 hrs (2G)</td>
    ...
    <tr>
      <td>Bluetooth</td>
      <td>Yes, v2.1, Supported Profiles (EDR, HSP)</td>
    </tr>
    <tr>
      <td>Audio Jack</td>
      <td>3.5 mm</td>
      ...
      <td width="560">Yes, Supports MP3, MIDI, WAV</td>
    </tr>
    <tr>
      <td>Video Player</td>
      <td>Yes, Supports MP4, 3GP</td>
    </tr>
    <tr>
      <td>FM</td>
      <td>Yes</td>
    ...
    <tr>
      ...
      <td>Game, Intuitive Text Input and Spell Check</td>
    </tr>
    <tr>
      <td>Important Apps</td>
      <td>Hookup, Mi Zone+, M live, Facebook, Cricket Fever, Google Play Store, Pre-loaded Apps, Mi Store, WhatsApp</td>
    </tr>
                      </tbody>
       </table>
