...
<!-- Begin Wrapper -->
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../MENU/Sony.php" title="Sony">Sony</a> / <a href="#" title="Sony Xperia GO">Sony Xperia GO </a><br />
			<br /><br />
					<img id="Main" src="../css/images/Mobile/sonyego0.jpeg" height="380" width="172" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u>Sony Xperia GO   (Warm Yellow)</u></span>
					<br/>
					<br /><br/><br />
					<p>
			  ...
			  &nbsp;&nbsp;<img src="../css/images/Mobile/sonyego0.jpeg" height="142" width="69" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/Mobile/sonyego1.jpeg" height="139" width="71" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <span class="style12">Specifications of Sony Xperia GO  (Warm Yellow)</span>
	 ...
	 <div class="effect">
                      ...
                      <tbody>
                        <tr>
                          <th colspan="2" align="justify"><span class="style13">Platform</span>   </th>
                                ...
                                <tr>
                                  <td>Processor</td>
                                  <td>1 GHz ARM Cortex-A9, Dual Core</td>
                                </tr>
                                <tr>
                                  <td>Graphics</td>
                                  <td>ARM Mali 400</td>
					...
					<table width="865" cellspacing="5">
					  <tbody>
                        ...
                        <tr>
                          ...
                          <td>Scratch Resistant, Dust and Water Resistant, Screenshot Capturing, Auto Rotation, Gesture Input, Mobile Bravia Engine</td
                        ></tr>
				      </tbody>
       </table>
					<br />
					...
					<table width="864" cellspacing="5">
					  <tbody>
                        ...
                        <tr>
                          ...
                          <td width="552">Yes, 5 Megapixel</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td>Auto   Focus, Face and Smile Detection, 3D Sweep Panorama, Geo-tagging, Touch   Focus, Red-eye Reduction, Sweep Multi Angle, Send to Web</td>
                        </tr>
				      </tbody>
       </table>
					<br />
					...
					<table width="865" cellspacing="5">
					  <tbody>
                        ...
                        <tr>
                          ...
                          <td width="552">60.3x111x9.8 mm</td>
                        </tr>
                        <tr>
                          <td>Weight</td>
                          <td>110 g</td>
					...
					<table width="865" cellspacing="5">
					  <tbody>
                        ...
                        <tr>
                          <td width="293">Type</td>
                          <td width="551">Li-Ion, 1305 mAh</td>
                        </tr>
                        <tr>
                          <td>Talk Time</td>
					...
					<table width="866" cellspacing="5">
					  <tbody>
                        ...
                        <tr>
                          ...
                          <td width="552">Email, Adobe Flash 11</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td>Bluetooth</td>
                          <td>Yes, v3, Supported Profiles (A2DP, AVRCP, OPP, PAP, HFP, HSP)</td>
                        </tr>
                        <tr>
                          <td>Audio Jack</td>
                          <td>3.5 mm</td>
					...
					<table width="866" cellspacing="5">
					  <tbody>
                        ...
                        <tr>
                          ...
                          <td width="554">Yes, Supports MP3, eAAC, WAV</td>
                        </tr>
                        <tr>
                          <td>Video Player</td>
                          <td>Yes, Supports MP4, H.263, H.264, WMV, 3GPP, AVI, HD</td>
                        </tr>
                        <tr>
                          <td>FM</td>
                          <td>Yes</td>
                        ...
                        <tr>
                          ...
                          <td>3D Surround Sound, xLoud Audio Filter Technology</td>
                        </tr>
                        <tr>
                          <td>Ringtone</td>
                          <td>MP3</td>
					...
					<table width="867" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
                          <td>Sensors</td>
                          <td>Accelerometer, Proximity Sensor, Compass, Ambient Light Sensor</td>
                        </tr>
                        <tr>
                          <td>Additional Features</td>
                          <td>MMS   Enabled, Audio Recording, Motion Gaming, Handwriting Recognition,   Calendar, Sound Recorder, Alarm Clock, Audio and Video Streaming, 3D   Album, 3D Gallery, Flight Mode, Calculator, Office Suite Pro, Stopwatch,   Timer, Torch, Voice Input</td>
                        </tr>
                        <tr>
                          <td>Important Apps</td>
                          <td>Google   Voice Search, Google Talk, Google Mail, Micoach, Walk Mate, Facebook,   Twitter, Instant Messaging, YouTube, Google Search, Google Play, Skype</td>
                        </tr>
                      </tbody>
                    </table>
					<br />
