	...
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			...
			<br /><br />
					<img src="../css/images/Mobile/nkasha31one0.jpeg" name="Main" width="211" height="400" align="left" id="Main"/>
					
		  <div class="effect2"> <span class="style10"><u>Nokia Asha 311 (Dark Grey)</u></span>
					<br/><br /><br/><br />
					<p>
			  ...
			  &nbsp;&nbsp;<img src="../css/images/Mobile/nkasha31one0.jpeg" height="139" width="69" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/Mobile/nkasha31one1.jpeg" height="139" width="71" onmousemove="showT(src)" />&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <span class="style12">Specifications of  Nokia Asha 311 (Dark Grey)</span>
