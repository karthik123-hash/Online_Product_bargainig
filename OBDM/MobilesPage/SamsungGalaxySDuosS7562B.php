...
<title>PC-Store  A BarGaining WorlD</title>
	...
	session_start(); 
		  ...
		  $_SESSION['pname']=$pn;
		  $Barg=$_SESSION['barg'];
		  if($pn!="Samsung Galaxy S Duos S7562(BLACK)")
...
<br /><br />
					<img src="../css/images/Mobile/ssgalaxysduoss75620.jpeg" name="Main" width="211" height="400" align="left" id="Main"/>
					
		  <div class="effect2"> <span class="style10"><u> Samsung Galaxy S Duos S7562 (BLACK)</u></span>
					<br/>
					<br /><br/><br />
					<p>
			  ...
			  &nbsp;&nbsp;<img src="../css/images/Mobile/ssgalaxysduoss75620.jpeg"  height="142" width="74" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
			  		 <img src="../css/images/Mobile/ssgalaxysduoss75622.jpeg"  height="142" width="74" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
					 <img src="../css/images/Mobile/ssgalaxysduoss75623.jpeg"  height="142" width="74" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <span class="style12">Specifications of Samsung Galaxy S Duos S7562(BLACK)</span>
