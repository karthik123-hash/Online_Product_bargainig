...
<title>PC-Store  A BarGaining WorlD</title>
	...
	session_start(); 
		  ...
		  $_SESSION['pname']=$pn;
		  $Barg=$_SESSION['barg'];
		  if($pn!="Micromax Canvas2 Plus A110Q")
...
<body>
	...
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../MENU/Micromax.php" title="Micormax">Micromax</a> / <a href="#" title="Micromax Canvas 2 Plus A110Q">Micromax Canvas 2 Plus A110Q</a><br />
			<br /><br />
					<img src="../css/images/Mobile/mmcanvas2plus0.jpeg" name="Main" width="191" height="380" align="left" id="Main"/>
					
		  <div class="effect2"> <span class="style10"><u>Micromax Canvas 2 Plus A110Q(Black)</u></span>
					<br/>
					<br /><br/><br />
					<p>
			  ...
			  &nbsp;&nbsp;<img src="../css/images/Mobile/mmcanvas2plus0.jpeg" height="142" width="69" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/Mobile/mmcanvas2plus1.jpeg" height="146" width="71" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <span class="style12">Specifications of Micromax Canvas 2 Plus A110Q (Black)</span>
	 ...
	 <div class="effect">
      ...
      <td width="553">Battery, USB Cable, Headset, Warranty Card, Handset, Charger, User Guide</td>
    </tr>
    <tr>
      <td>Brand</td>
      <td>Micromax</td>
    ...
    <tr>
      ...
      <td>Document Viewer, Google Document, Spreadsheets</td>
    </tr>
    <tr>
      <td>Call Features</td>
    ...
    <tr>
      <td>OS</td>
      <td>Android v4.2.1 (Jelly Bean)</td>
    </tr>
    <tr>
      <td>Processor</td>
    ...
    <tr>
      ...
      <td width="559">Apps: 1.4 GB; Mass Storage: 1 GB</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td width="562">Yes, Supports WAV, MP3, MIDI</td>
    </tr>
    <tr>
      <td>Video Player</td>
      <td>Yes, Supports MP4, AVI, 3GP, MKV, HD</td>
    </tr>
    <tr>
      <td>FM</td>
      <td>Yes</td>
      ...
      <td width="564">At the Head - 0.34 W/Kg, At the Body - 0.39 W/Kg</td>
    </tr>
    <tr>
      <td>Call Memory</td>
      <td>Yes</td>
    ...
    <tr>
      <td>Sensors</td>
      <td>Accelerometer, Proximity Sensor, Light Sensor, Gravity Sensor</td>
    </tr>
    <tr>
      <td>Additional Features</td>
      <td>Multi-tasking,   Intuitive Text Input and Spell Check, Games, MMS Enabled, Flight Mode,   Notifications, Voice Search, Sound Recorder, Bluetooth Tethering,   Calendar, Voice Input</td>
    </tr>
    <tr>
      <td>Important Apps</td>
      <td>M! Live, M! Zone+, Hook Up, Voice Chats, Google, Gmail, Android Market, Widgets, Picasa</td>
    </tr>
                      </tbody>
       </table>
