...
<body>
	...
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../MENU/Nokia.php" title="Nokia">Nokia</a> / <a href="NokiaAsha210.php" title="Nokia Asha 210">Nokia Asha 210</a><br />
			<br /><br />
					<img src="../css/images/Mobile/nkasha2ten0.jpeg" name="Main" width="218" height="400" align="left" id="Main"/>
					
		  <div class="effect2"> <span class="style10"><u>Nokia Asha 210(Black)</u></span>
					<br/><br /><br/><br />
					<p>
				...
				<strong>1 year manufacturer warranty for Phone and 6 months warranty for in the box accessories Nokia India Warranty and Free Transit                      Insurance.</strong>				  
					...
					<div id="log" >
					  ...
					  <span class="style12"><strong>Set Your Price To Bargain</strong></span><br />
			            <br /></div><form id="myform" name="myform" action="../Calculate1.php" method="post" >	
			  ...
			  &nbsp;&nbsp;<img src="../css/images/Mobile/nkasha2ten0.jpeg" height="142" width="79" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/Mobile/nkasha2ten1.jpeg" height="146" width="78" onmousemove="showT(src)" />&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <span class="style12">Specifications of Nokia Asha 210(Black)</span>
	 ...
	 <div class="effect">
      ...
      <td width="552">Handset, Battery, Headset, 4 GB MicroSD Card, Visual User Guide, Charger</td>
    </tr>
    <tr>
      <td>Brand</td>
      <td>Nokia</td>
    ...
    <tr>
      ...
      <td width="552">GSM - 850, 900, 1800, 1900</td>
    </tr>
    <tr>
      <td>OS</td>
      <td>(Series 40)</td>
    ...
    <tr>
      ...
      <td width="556">LCD Transmissive</td>
    </tr>
    <tr>
      <td>Size</td>
      <td>2.4 Inches</td>
    ...
    <tr>
      ...
      <td width="559">Yes, 2 Megapixel</td>
    </tr>
    <tr>
      <td>Video Recording</td>
      <td>Yes, 176 x 144, 10 fps</td>
    </tr>
    <tr>
      <td>Zoom</td>
    ...
    <tr>
      ...
      <td>Fixed Focus, 35 mm Focal Length, Minimum Focus Range: 60 cm, White Balance Modes, Automatic Light Sensitivity</td>
    </tr>
                      </tbody>
       </table>
      ...
      <td width="557">60x111.5x11.8 mm</td>
    </tr>
    <tr>
      <td>Weight</td>
      <td>99.5 g</td>
    ...
    <tr>
      <td>Bluetooth</td>
      <td>Yes, v2.1, Supported Profiles (EDR, PBAP 1.0, SDAP, OPP 1.1, HSP 1.1, SPP, HFP 1.5)</td>
    </tr>
    <tr>
      <td>Audio Jack</td>
      <td>3.5 mm</td>
                   ...
                   <br /><br />
                    <table width="873" cellspacing="5">
                      <tbody>
                       ...
                       <tr>
      <td>Music Player</td>
      <td>Yes, Supports MP3</td>
    </tr>
    <tr>
      <td>Video Player</td>
      <td>Yes, Supports 3GP, MP4, ASF, AVI, M4V</td>
    </tr>
    <tr>
      <td>FM</td>
      <td>Yes</td>
    ...
    <tr>
      ...
      <td>Calculator,   Clock, World Clock, Calendar, Converter, Notes, Alarm, Reminders, To-do   List, Games, MMS and SMS Editor, Automatic Answer, Call Waiting,   Automatic Redial, Call Barring, Speech Codecs, Firmware Update, Device   Lock, Device Passcode, PIN Code, Secure Device Start-up, Photo Sharing   with Slam, Video Sharing, Music Codec, Voice Recorder, Video Codec,   Video Streaming</td>
    </tr>
    <tr>
      <td>Important Apps</td>
      <td>WAPI, Instant Messaging, Twitter, WhatsApp, Direct Chat, Facebook, Nokia Life</td>
    </tr>
                      </tbody>
       </table>
