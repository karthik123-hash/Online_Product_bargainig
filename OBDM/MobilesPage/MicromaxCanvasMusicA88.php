...
<title>PC-Store  A BarGaining WorlD</title>
	...
	<?php
	 ...
	 session_start(); 
		  ...
		  $_SESSION['pname']=$pn;
		  $Barg=$_SESSION['barg'];
		  if($pn!="Micromax Canvas Music A88")
...
<body>
	...
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../MENU/Micromax.php" title="Micormax">Micromax</a> / <a href="#" title="Micromax Canvas Music A88">Micromax Canvas Music A88</a><br />
			<br /><br />
					<img src="../css/images/Mobile/mmcanvasmusica0.jpeg" name="Main" width="191" height="380" align="left" id="Main"/>
					
		  <div class="effect2"> <span class="style10"><u>Micromax Canvas Music A88 (White)</u></span>
					<br/>
					<br /><br/><br />
					<p>
			  ...
			  &nbsp;&nbsp;<img src="../css/images/Mobile/mmcanvasmusica0.jpeg" height="142" width="69" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/Mobile/mmcanvasmusica1.jpeg" height="146" width="71" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <span class="style12">Specifications ofMicromax Canvas Music A88  (White)</span>
			        ...
			        <table width="865" cellspacing="5">
		              <tbody>
		                <tr>
                         ...
                         <tr>
      <td width="295">In Sales Package</td>
      <td width="549">Charger, Handset, JBL Headphone, Headset, Battery, User Guide, Warranty Card, USB Cable</td>
    </tr>
    <tr>
      <td>Brand</td>
      <td>Micromax</td>
    ...
    <tr>
      <td>Call Features</td>
      <td>Speed Dialing, Loudspeaker</td>
    </tr>
    <tr>
      <td>Handset Color</td>
      <td>White</td>
    ...
    <tr>
      <td>OS</td>
      <td>Android v4.1.1 (Jelly Bean)</td>
    </tr>
    <tr>
      <td>Processor</td>
    ...
    <tr>
      ...
      <td>Auto Focus, Zoom Level - 5, Multi-shot Mode, Night Mode, Camera Sensor Settings</td>
    </tr>
                      </tbody>
       </table>
      ...
      <td width="560">68.7x135x11.3 mm</td>
    </tr>
                      </tbody>
       </table>
      ...
      <td width="559">Li-Ion, 1800 mAh</td>
    </tr>
    <tr>
      <td>Talk Time</td>
      <td>5 hrs (2G)</td>
    ...
    <tr>
      <td>Bluetooth</td>
      <td>Yes, v4, Supported Profiles (SPP, OPP, AVRCP, DUN, A2DP)</td>
    </tr>
    <tr>
      <td>Audio Jack</td>
      <td>3.5 mm</td>
      ...
      <td width="559">Yes, Supports MIDI, MP3, WAV</td>
    </tr>
    <tr>
      <td>Video Player</td>
      <td>Yes, Supports AVI, 3GP, MP4, HD</td>
    </tr>
    <tr>
      <td>FM</td>
    ...
    <tr>
      <td>Sensors</td>
      <td>Gravity Sensor, Proximity Sensor</td>
    </tr>
    <tr>
      <td>Additional Features</td>
      <td>English   and Hindi Language Support, MMS Enabled, Streaming Support, Recorded FM   File Set as Ringtone, All Country Language Support, Predictive Text,   FDN Support, 10 SMS Templates, SMS Chat, Supports Proxy Disabled, 10   Call Black List, 10 Call White List, World Clock, Multiple Alarm,   Calculator, Calendar, Auto Power On / Off, Voice Recognizing, CLID with   Photo, CLID with Video, Bookmarks, Mobile Tracker, Incoming Call Guard,   Fax Support, Concatenated Messages</td>
    </tr>
    <tr>
      <td>Important Apps</td>
      <td>Google, Fruit Devil, The Darkman, Hook Up , M! Live, M! Zone+, Gmail</td>
    </tr>         </tbody>
       </table>
