...
<body>
	...
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../MENU/Micromax.php" title="Micormax">Micromax</a> / <a href="#" title="Micromax Canvas HD A116">Micromax Canvas HD A116</a><br />
			<br /><br />
					<img src="../css/images/Mobile/mmcanvasHDa0.jpeg" name="Main" width="191" height="380" align="left" id="Main"/>
					
		  <div class="effect2"> <span class="style10"><u>Micromax Canvas HD A116 (White)</u></span>
					<br/>
					<br /><br/><br />
					<p>
			  ...
			  &nbsp;&nbsp;<img src="../css/images/Mobile/mmcanvasHDa0.jpeg" height="142" width="69" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
			     <img src="../css/images/Mobile/mmcanvasHDa1.jpeg" height="142" width="69" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <span class="style12">Specifications of Micromax Canvas HD A116 (White)  </span>
	 ...
	 <div class="effect">
      ...
      <td width="550">Charger, Battery, Flip Cover, Headset, Handset, Warranty Card, USB Cable, User Guide</td>
    </tr>
    <tr>
      <td>Brand</td>
      <td>Micromax</td>
    ...
    <tr>
      <td>Call Features</td>
      <td>Conference Call, Hands Free, Loudspeaker</td>
    </tr>
    <tr>
      <td>Handset Color</td>
      <td>White</td>
    ...
    <tr>
      ...
      <td>Pinch-to-Zoom, IPS Display</td>
    </tr>
                      </tbody>
       </table>
      ...
      <td width="555">Yes, 8 Megapixel</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Auto Focus, Night Mode, Creative and Shoot Stop-motion, Burst Mode, Zoom - 4x, White Balance, Color Effect, Scene Mode</td>
    </tr>
                      </tbody>
       </table>
      ...
      <td width="561">74x144x10.7 mm</td>
    </tr>
                      </tbody>
       </table>
    ...
    <tr>
      <td>3G</td>
      <td>Yes, 21 Mbps HSDPA; 11 Mbps HSUPA</td>
    </tr>
    <tr>
      <td>Wifi</td>
      <td>Yes</td>
    ...
    <tr>
      ...
      <td width="560">Yes, Supports eAAC+, MIDI, MP3</td>
    </tr>
    <tr>
      <td>Video Player</td>
      <td>Yes, Supports H.264, H.263, 3GP, MPEG-4, HD</td>
    </tr>
    <tr>
      <td>FM</td>
      <td>Yes</td>
      ...
      <td width="563">At the Head - 0.472 W/Kg, At the Body - 0.412 W/Kg</td>
    </tr>
    <tr>
      <td>Call Memory</td>
      <td>Yes</td>
    ...
    <tr>
      <td>Sensors</td>
      <td>Light Sensor, Proximity Sensor, Gravity Sensor, Accelerometer</td>
    </tr>
    <tr>
      <td>Additional Features</td>
      <td>Multi-task, Intuitive Text Input and Spell Check, Games, Live TV, Voice Search, Flight Mode, Sound Recorder, Widget, Voice Input</td>
    </tr>
    <tr>
      <td>Important Apps</td>
      <td>Hook Up, M! Zone+, Mi Live, Google Play Store, Mi Zone, MiSMS App, Mi Store App, Facebook</td>
    </tr>
                      </tbody>
       </table>
