...
<body>
	...
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../MENU/Sony.php" title="Sony">Sony</a> / <a href="#" title="Sony Xperia Miro">Sony Xperia Miro </a><br />
			<br /><br />
					<img id="Main" src="../css/images/Mobile/sonyemiro0.jpeg" height="380" width="172" align="left"/>
					
		  <div class="effect2"> <span class="style10"><u>Sony Xperia Miro   (Black)</u></span>
					<br/>
					<br /><br/><br />
					<p>
			  ...
			  &nbsp;&nbsp;<img src="../css/images/Mobile/sonyemiro0.jpeg" height="142" width="69" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
                     <img src="../css/images/Mobile/sonyemiro1.jpeg" height="146" width="71" onmousemove="showT(src)" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <span class="style12">Specifications of Sony Xperia Miro  (Black)</span>
	 ...
	 <div class="effect">
      ...
      <td width="553">Handset, Battery, Charger, Headset, Data Cable, SIM Card Adaptor</td>
    </tr>
    <tr>
      <td>Brand</td>
      <td>Sony</td>
    ...
    <tr>
      <td>Processor</td>
      <td>800 MHz Qualcomm Scorpion</td>
    </tr>
    <tr>
      <td>Graphics</td>
      <td>Adreno 200</td>
    ...
    <tr>
      ...
      <td>Scratch-resistant, Handwriting Recognition, Gesture Support, Multi-touch</td>
    </tr>             </tbody>
       </table>
         ...
         <tr>
      <td width="295">Primary Camera</td>
      <td width="555">Yes, 5 Megapixel</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Auto   Focus, Geo-tagging, Touch Focus, Face and Smile Detection, 3D Sweep   Panorama, Video Light, Video Stabilizer, Self Timer, Touch Capture,   Photo Flash, Photo Light, Send to Web</td>
    </tr>             </tbody>
       </table>
      ...
      <td width="561">59.4x113x9.9 mm</td>
    </tr>
    <tr>
      <td>Weight</td>
      <td>110 g</td>
                    ...
                    <table width="872" cellspacing="5">
                      <tbody>
                        ...
                        <tr>
      <td width="291">Type</td>
      <td width="560">Li-Ion, 1500 mAh</td>
    </tr>
    <tr>
      <td>Talk Time</td>
      <td>5 hrs (2G), 6 hrs (3G)</td>
    </tr>
    <tr>
      <td>Standby Time</td>
      <td>470 hrs (2G), 545 hrs (3G)</td>
    </tr>
                      </tbody>
       </table>
      ...
      <td width="558">4 GB (2.2 GB User Memory)</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td width="560">Yes, Supports MP3, eAAC, MIDI, WAV</td>
    </tr>
    <tr>
      <td>Video Player</td>
      <td>Yes, Supports MP4, H.263, H.264, MPEG4, 3GPP</td>
    </tr>
    <tr>
      <td>FM</td>
      <td>Yes</td>
    ...
    <tr>
      ...
      <td>xLOUD Audio Filter Technology, TrackID Music Recognition</td>
    </tr>
    <tr>
      <td>Ringtone</td>
      <td>MP3</td>
                      ...
                      <tbody>
                        <tr>
                           <th colspan="2" align="justify"><span class="style13">Other Features</span></th>
                            ...
                            <tr>
      <td width="296">SAR Value</td>
      <td width="558">0.87 W/Kg</td>
    </tr>
    <tr>
      <td>Call Memory</td>
      <td>Yes</td>
    ...
    <tr>
      <td>Sensors</td>
      <td>Accelerometer, Proximity Sensor, Magnetometer</td>
    </tr>
    <tr>
      <td>Additional Features</td>
      <td>Predictive   Text Input, MMS Enabled, Google Sync, 3D Gaming, Audio Recording,   Street View and Latitude, Pan and Zoom, Alarm Clock, Airplane Mode,   Calculator, Calendar, Setup Wizard, Wallpaper Animation, Sony   Entertainment Network, Manual Equaliser, 50 GB Free Cloud Storage, Auto   Rotation, eCompass, Album Art, Voice Input, Voice Input, Voice Input</td>
    </tr>
    <tr>
      <td>Important Apps</td>
      <td>Facebook, Google, Google Voice Search, Google Talk, Google Mail, Multiple Instant Messaging, YouTube, Twitter, Google Play</td>
    </tr>
                      </tbody>
       </table>
