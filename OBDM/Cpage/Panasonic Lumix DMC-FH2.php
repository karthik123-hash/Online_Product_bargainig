...
<!-- Begin Wrapper -->
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../CMENU/panasonic.php" title="Panasonic">Panasonic</a> / <a href="#" title="Panasonic Lumix DMC-FH2">Panasonic Lumix DMC-FH2</a><br />
			<br /><br />
					<img src="../css/images/camera/panasonic-lumix-dmc-fh21.jpeg" name="Main" width="274" height="181" align="left" id="Main"/>
					
		  <div class="effect2"> <span class="style10"><u> Panasonic Lumix DMC-FH2 Point & Shoot
(Pink)</u></span>
					<br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/camera/panasonic-lumix-dmc-fh22.jpeg" height="108" width="132" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;<img src="../css/images/camera/fujifilm-f6602.jpeg" width="142" height="102" onmousemove="showT(src)"/>&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      ...
			      <span class="style12">Specifications of Panasonic DMC-GF2 (White) </span>
    ...
    <tr>
      ...
      <td width="551">475 g (SD Memory Card, Battery, Lens Included)</td>
    </tr>
    <tr>
      <td height="12">Dimensions</td>
      <td> 	112.8 (W) x 67.8 (H) x 32.8 (D) mm</td>
    </tr>
    ...
    <tr>
      <td>Focal Length</td>
      <td> 	14 mm (35 mm Equivalent 28 mm)</td>
    </tr>
    ...
    <tr>
      <td>Video Format</td>
      <td> 	AVCHD, Motion JPEG</td>
    </tr>
    <tr>
      <td>Image Format</td>
      <td> 	JPEG, DCF, EXIF 2.3, RAW, DPOF, MPO</td>
    </tr>
    <tr>
      ...
      <td width="560">Auto, Auto with Red-eye Reduction, Forced On, Red-eye Reduction, Slow Sync, Slow Sync with Red-eye Reduction, Forced Off</td>
    </tr>
    <tr>
      <td>Flash Range</td>
