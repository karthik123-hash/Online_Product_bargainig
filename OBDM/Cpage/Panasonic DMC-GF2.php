...
<!-- Begin Wrapper -->
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../CMENU/panasonic.php" title="Panasonic">Panasonic</a> / <a href="#" title="Panasonic DMC-GF2">Panasonic DMC-GF2</a><br />
			<br /><br />
					<img src="../css/images/camera/panasonic-dmc-gf3-mirrorless1.jpeg" name="Main" width="274" height="181" align="left" id="Main"/>
					
		  <div class="effect2"> <span class="style10"><u> Panasonic DMC-GF2
(White)</u></span>
					<br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/camera/panasonic-dmc-gf3-mirrorless1.jpeg" height="108" width="132" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;<img src="../css/images/camera/panasonic-dmc-gf3-mirrorless3.jpeg" width="142" height="102" onmousemove="showT(src)"/>&nbsp;&nbsp;&nbsp;
