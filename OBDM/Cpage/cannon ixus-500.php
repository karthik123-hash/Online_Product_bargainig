...
<body>
	...
	<div id="wrapper">
	  ...
	  <div id="header" class="shell">
		...
		<div class="effect1">  
			<a href="../Main/Main.php" title="Home">Home</a> / <a href="../CMENU/canon.php" title="Canon">Canon</a> / <a href="#" title="Canon Digital IXUS 500 HS Point & Shoot">Canon Digital IXUS 500 HS Point & Shoot</a><br />
			<br /><br />
					<img src="../css/images/camera/cannon2.jpeg" name="Main" width="277" height="282" align="left" id="Main"/>
					
		  <div class="effect2"> <span class="style10"><u> Canon Digital IXUS 500 HS Point & Shoot
(Red)</u></span>
					<br/>
					<br /><br/><br />
					<p>
	...
	var r=confirm("ARE U SURE WANT Buy !");
 	if (r==false)
    	return false;
			  ...
			  &nbsp;&nbsp;<img src="../css/images/camera/cannon3.jpeg" height="142" width="69" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
			     <img src="../css/images/camera/cannon2.jpeg" height="142" width="69" onmousemove="showT(src)"/> &nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	 ...
	 <div class="effect">
      ...
      <td width="550">USB Cable, User Manual, 4 GB Memory Card, Camera Pouch (Inside the Box), Battery Charger with Rechargeable Lithium Batteries</td>
    </tr>
    ...
    <tr>
      ...
      <td width="551">135 g (Camera Body Only), 155 g (with Battery and Memory Card)</td>
    </tr>
    <tr>
      <td>Dimensions</td>
      <td>87.1 (W) x 53.9 (H) x 19.2 (D) mm</td>
    </tr>
                   ...
                   <tr>
      <td width="292">Optical Sensor Resolution (in MegaPixel)</td>
      <td width="557">10.1 Megapixels</td>
    </tr>
    <tr>
    ...
    <tr>
	 ...
	 <tr>
      ...
      <td width="558">Power Adapter CA-DC 10 (Included with AC Adapter Kit ACK-DC70)</td>
    </tr>
    <tr>
      <td>Battery Type</td>
    ...
    <tr>
      <td>Focal Length</td>
      <td>4.0 (W) - 48.0 (T) mm (35 mm Equivalent to 28 (W) - 336 (T) mm)</td>
    </tr>
	<tr>
      <td>Color Filter</td>
    ...
    <tr>
	 ...
	 <tr>
      ...
      <td>Yes, 2.8 fps (P Mode), 6.8 fps (High-speed Burst Mode)</td>
    </tr>
	 <tr>
